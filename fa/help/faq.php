...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_FORMATTING_SMILIES_ANSWER'	=>  'شکلکک‌ها تصاویر کوچکی هستند که برای بیان احساسات به کار میروند برای مثل :) نشان میدهد که شما خوشحال هستید و یا while :( نشانگر ناراحت بودن است. لیست کامل این شکلکک‌ها در صفحات ارسال موجود می‌باشد.از شکلکک‌ها بیش از اندازه استفاده نکنید.استفاده بیش از حد موجب ناخوانا شدن پست میگردد و در این صورت مدیر میتواند پست و یا فقط شکلکک‌ها را حذف کند،همچنین مدیر میتواند محدودیت هایی را برای ارسال شکلک اعمال کند.',
	'HELP_FAQ_FORMATTING_SMILIES_QUESTION'	=> 'شکلکک‌ها چه هستند ؟',
