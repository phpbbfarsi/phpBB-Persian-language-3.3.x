...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> 'با استفاده از این لیست می‌توانید سایر کاربران تالار را سازمان دهی کنید. به کاربرانی که به لیست دوستانتان اضافه کرده باشید،دسترسی سریعی خواهید داشت و این کاربران به کنترل پنل کاربریتان اضافه خواهند شد تا وضعیت آنلاین و یا برون‌خط بودن آن‌ها را سریع تر ببینید و سریع تر به آن‌ها پیام خصوصی بفرستید. بسته به قالب تالار ممکن است پست‌های دوستانتان درشت تر نشان داده شود. اگر کاربری را به لیست دشمنانتان اضافه کنید،هیچکدام از پست‌های این کاربران به شما نمایش داده نخواهند شد.',
