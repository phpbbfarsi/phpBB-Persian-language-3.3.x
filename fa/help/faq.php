...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_ISSUES_FEATURE_ANSWER'	=>  'این نرم افزار توسط گروه phpBB برنامه نویسی و لایسنس شده است.اگر بر این باور هستید که ویژگی ای به این نرم افزار باید اضافه شود،لطفاً از سایت phpbb.com بازدید کرده و منتظر پاسخ گروه phpBB باشید.لطفاً درخواستتان را در انجمن‌ها ارسال نکنید.گروه از SourceForge برای بررسی ویژگی ها استفاده میکند.لطفاً ابتدا با دقت انجمن‌ها را جستجو کنید شاید این ویژگی در حال حاضر موجود است.',
	'HELP_FAQ_ISSUES_FEATURE_QUESTION'	=> 'چرا ویژگی X موجود نیست ؟',
	'HELP_FAQ_ISSUES_LEGAL_ANSWER'	=>  'می‌توانید با هر مدیری که در بخش "تیم پشتیبانی" وجود دارد تماس بگیرید.اگر پاسخی دریافت نکردید می‌توانید با دارنده دامنه این سایت تماس بگبربد(در<a href="http://www.google.com/search?q=whois">whois</a>بگردید) و یا اگر این سایت در سرویسی مجانی فعالیت میکند (مانند Yahoo!,free.fr.f2s.com و غیره)موضوع را به مسئولین این سرویس ها اطلاع بدهید، توجه داشته باشید که گروه phpBB هیچ گونه مسئولیتی در قبال مسائل حقوقی ندارد و در هیچ دادگاه مربوطه ای شرکت نمیکند لطفاً در موضوعاتی که به طور مستقیم به ما مربوط نمیشود،به ما ایمیل نفرستید.برای شکایت از سایت های غیرمستقیم مرتبط با phpBB ممکن است پاسخ کوتاهی دریافت کنید و یا اصلا به شما پاسخ داده نشود.',
	...
	'HELP_FAQ_PMS_SPAM_ANSWER'	=>  'در مورد این مسئله پوزش میخواهیم. بخش ایمیل این تالار دارای ویژگی هایی است که کاربرانی را که اسپم میفرستند را شناسایی میکند، لطفاً متن کامل ایمیلی را که دریافت کرده اید را به مدیر تالار ارسال کنید. حتما جزئیات فرستنده ایمیل را هم در این نامه ذکر کنید تا مدیر اقدامات لازم را انجام دهد.',
	'HELP_FAQ_PMS_SPAM_QUESTION'	=> 'ایمیل های اسپم و توهین آمیزی را از جانب فردی در این تالار دریافت میکنم !',
	'HELP_FAQ_PMS_UNWANTED_ANSWER'	=>  'می‌توانید در کنترل پنل کاربری،در بخش قوانین پیام خصوصی از دریافت پیام خصوصی از جانب کاربر(ان) خاصی جلوگیری کنید. اگر این پیام‌ها را از جانب کاربر مشخصی دریافت میکنید، لطفاً این موضوع را به مدیران اطلاع دهید،آن‌ها میتوانند از ارسال این پیام‌ها توسط کاربری جلوگیری کنند.',
	...
	'HELP_FAQ_POSTING_NO_ATTACHMENTS_ANSWER'	=>  'در هر انجمن،گروه و یا کاربر سطوح دسترسی متفاوتی دارد. ممکن است مدیر انجمن اجاه ارسال پیوست را در انجمنی صادر نکند و یا گروه ثابتی میتوانند پیوست ارسال کنند اگر از اینکه چرا نمی‌توانید پیوستی را ارسال کنید،مطمئن نیستید لطفاً با مدیر تالار تماس بگیرید.',
	'HELP_FAQ_POSTING_NO_ATTACHMENTS_QUESTION'	=> 'چرا نمیتوانم پیوستی را اضافه کنم ؟',
	'HELP_FAQ_POSTING_POLL_ADD_ANSWER'	=>  'محدودیت برای گزینه‌های نظرسنجی از جانب مدیر تنظیم میشود. اگر به گزینه‌های بیشتری برای ایجاد نظرسنجی نیاز دارید،لطفاً با مدیریت تماس بگیرید.',
	...
	'HELP_FAQ_POSTING_WARNING_ANSWER'	=>  'هر تالاری قوانین خاص خودش را دارد. اگر قانونی را رغایت نکنید ممکن است هشداری دریافت کنید. توجه داشته باشید که دریافت هشدار به تصمیم مدیر مربوط میشود. و گروه phpbb مسئولیتی در قبال این هشدار ها ندارد. اگر از اینکه چرا هشدار دریافت کرده اید مطمئن نیستید،لطفاً با مدیر تتماس بگیرید.',
	...
	'HELP_FAQ_SEARCH_MEMBERS_ANSWER'	=> 'از لیست اعضا دیدن کنید و روی پیوند "یافتن یک عضو" کلیک کنید.',
	...
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_ANSWER'	=>  'درون کنترل پنل کاربر زیر "تنظیمات انجمن" می‌توانید گزینه <em>حالن آنلاین بودن من را مخفی کن</em>. این گزینه را با کلیک بر روی  بله  فعال کنید و در این صورت آنلاین بودن شما را فقط مدیران،مدیران انجمن و خود شما مشاهده خواهید کرد. و به عنوان کاربری مخفی محسوب خواهید شد.',
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_QUESTION'	=> 'چگونه میتوانم از نمایش داده شدن نام کاربریم در لیست افراد آنلاین جلوگیری کنم ؟',
	'HELP_FAQ_USERSETTINGS_LANGUAGE_ANSWER'	=>  'مدیر تالا بسته زبانی شما را نصب نکرده است و یا کسی تالار را به زبان شما ترجمه نکرده است. لطفاً از مدیر تالار بپرسید که آیا میتواند بسته زبانی شما را نصب کند و یا نه،اگر بسته زبانیتان موجود نبود خودتان می‌توانید اقدام به ترجمه کنید (برای اطلاعات بیشتر به وبسایت phpbb مراجعه کنید).',
	'HELP_FAQ_USERSETTINGS_LANGUAGE_QUESTION'	=> 'زبان من در لیست موجود نیست !',
	'HELP_FAQ_USERSETTINGS_RANK_ANSWER'	=>  'رتبه‌ها،که معمولا در زیر نام کاربری قرار دارند به تعداد پست‌ها و هویت کاربر بستگی دارد مانند مدیران و مدیران انجمن عموما نمی‌توانید نام رتبه‌ها را که توسط مدیر تعیین شده اند،تغییر دهید. لطفاً از ارسال پست‌های ناملزوم به منظور افزایش رتبه خودداری کنید زیرا مدیران و مدیران انجمن به آسانی میتوانند تعداد پست‌های شما را پایین بیاورند و حتی در مواردی ممکن است هشدار دریافت کنید.',
	'HELP_FAQ_USERSETTINGS_RANK_QUESTION'	=> 'رتبه من چیست و چگونه میتوان آنرا تغییر بدهم ؟',
	'HELP_FAQ_USERSETTINGS_SERVERTIME_ANSWER'	=>  'اگر مطمئن هستید که وقت محلی را بر اساس UTC/ساعت تابستانی درست تنظیم کرده اید، پس ساعت سرور نادرست می‌باشد. لطفاً به مدیر تالار اطلاع دهید تا مشکل را حل کند.',
	'HELP_FAQ_USERSETTINGS_SERVERTIME_QUESTION'	=> 'وقت محلی را تغییر دادم ولی باز هم زمان نادرست است !',
	'HELP_FAQ_USERSETTINGS_TIMEZONE_ANSWER'	=>  'ممکن است زمان نمایشی از وقت محلی یک مکان،با مکانی که شمای  در آن زندگی میکنید متفاوت باشد در این صورت به کنترل پنل کاربری خود مراجعه کنید تا وقت محلی محل زندگیتان را انتخاب کنید، مانند لندن،ایتالیا،ایران و ... . لطفاً به یاد داشته باشید که این تنظیم مانند سایر تنظیمات مخصوص کاربران عضو شده می‌باشد پس زمان خوبی است که در تالار ثبت نام کرده و از این تنظیمات بهره بگیرید.',
