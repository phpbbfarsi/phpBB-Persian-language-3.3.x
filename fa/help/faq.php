...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> 'با استفاده از این لیست می‌توانید سایر کاربران تالار را سازمان دهی کنید. به کاربرانی که به لیست دوستانتان اضافه کرده باشید،دسترسی سریعی خواهید داشت و این کاربران به کنترل پنل کاربریتان اضافه خواهند شد تا وضعیت برخط و یا برون‌خط بودن آن‌ها را سریع تر ببینید و سریع تر به آن‌ها پیام خصوصی بفرستید. بسته به قالب تالار ممکن است پست‌های دوستانتان درشت تر نشان داده شود. اگر کاربری را به لیست دشمنانتان اضافه کنید،هیچکدام از پست‌های این کاربران به شما نمایش داده نخواهند شد.',
	...
	'HELP_FAQ_LOGIN_AUTO_LOGOUT_ANSWER'	=>  'اگر <em>در هر بازدید به طور خودکار من را وارد کن</em> را انتخاب نکرده باشید،تالار فقط در زمان کنونی شما را برخط نگه خواهد داشت. این سیستم از هر گونه سوء استفاده از حسابتان جلوگیری خواهد کرد،برای برخط ماندن جمله ذکر شده را انتخاب کنید. اگر از کامپیوتر اشتراکی استفاده میکنید،انتخاب این گزینه توصیه نمیشود، برای مثال کتاب خانه،کافی نت؛کامپیوتر های دانشگاه و ... . اگر این گزینه را در حین ورود نمیبینید،این بدین معنا است که مدیر تالار این ویژگی را غیرفعال کرده است.',
	...
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_ANSWER'	=>  'درون کنترل پنل کاربر زیر "تنظیمات انجمن" می‌توانید گزینه <em>حالن برخط بودن من را مخفی کن</em>. این گزینه را با کلیک بر روی <samp>بله</samp> فعال کنید و در این صورت برخط بودن شما را فقط مدیران،مدیران انجمن و خود شما مشاهده خواهید کرد. و به عنوان کاربری مخفی محسوب خواهید شد.',
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_QUESTION'	=> 'چگونه میتوانم از نمایش داده شدن نام کاربریم در لیست افراد برخط جلوگیری کنم ؟',
