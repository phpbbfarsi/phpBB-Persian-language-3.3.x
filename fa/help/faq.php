...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_LOST_PASSWORD_ANSWER'	=> 'نگران نباشید! گذرواژه به راحتی قابل بازیابی است. به صفحه ورود رجوع کنید و بر روی <em>گذرواژه‌ام را فراموش کرده ام</em>کلیک کنید. دستورالعمل ها را به دقت دنبال کنید،به زودی خواهید توانست که وارد شوید.',
