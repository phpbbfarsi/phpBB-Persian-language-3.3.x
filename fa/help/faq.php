...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_FORMATTING_BBOCDE_ANSWER'	=> 'BBCode برنامه ای برای HTML است، برای استفاده از این ابزار،مدیر تالا باید BBCode را فعال کرده باشد. BBCode مانند تگ های HTML است با این تفاوت که به جای <> باید از قلاب ([]) استفاده کنید.در پست ها میتوانید BBCode غیرفعال کنید.',
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> 'با استفاده از این لیست میتوانید سایر کاربران تالار را سازمان دهی کنید. به کاربرانی که به لیست دوستانتان اضافه کرده باشید،دسترسی سریعی خواهید داشت و این کاربران به کنترل پنل کاربریتان اضافه خواهند شد تا وضعیت آنلاین و یا آفلاین بودن آن‌ها را سریع تر ببینید و سریع تر به آن‌ها پیام خصوصی بفرستید. بسته به قالب تالار ممکن است پست های دوستانتان درشت تر نشان داده شود. اگر کاربری را به لیست دشمنانتان اضافه کنید،هیچکدام از پست های این کاربران به شما نمایش داده نخواهند شد.',
	'HELP_FAQ_FRIENDS_BASIC_QUESTION'	=> 'لیست دوستان و دشمنان چیست ؟',
	'HELP_FAQ_FRIENDS_MANAGE_ANSWER'	=>  'به دو روش میتوانید کاربران را به لیست دوستانتان اضافه کنید، میتوانید کاربران را از لینکی که در نمایه آن‌ها وجود دارد به لیست دوستان و یا دشمنان خود اضافه کنید. دوم،در کنترل پنل کاربری خود میتوانید به طور مستقیم با وارد کردن نام کاربری آن‌ها را به لیست دوستان و یا دشمنانتان اضافه کنید. از همان صفحه میتوانید کاربران را از این دو لیست حذف کنید..',
	...
	'HELP_FAQ_PMS_UNWANTED_ANSWER'	=>  'میتوانید در کنترل پنل کاربری،در بخش قوانین پیام خصوصی از دریافت پیام خصوصی از جانب کاربر(ان) خاصی جلوگیری کنید. اگر این پیام ها را از جانب کاربر مشخصی دریافت میکنید، لطفا این موضوع را به مدیران اطلاع دهید،آن‌ها میتوانند از ارسال این پیام ها توسط کاربری جلوگیری کنند.',
	...
	'HELP_FAQ_USERSETTINGS_CHANGE_SETTINGS_ANSWER'	=>  'اگر در سایت ثبت نام کرده باشید،تمامی تنظیماتتان در پایگاه های داده ما ذخیره میشود. برای تغییر آن‌ها به کنترل پنل کاربریتان مراجعه کنید، این لینک معمولا در بالای صفحه تالار موجود است،از آنجا میتوانید تمامی تنظیماتتان را تغییر دهید.',
	...
	'HELP_FAQ_USERSETTINGS_SERVERTIME_ANSWER'	=>  'اگر مطمئن هستید که وقت محلی را براساس UTC/ساعت تابستانی درست تنظیم کرده اید، پس ساعت سرور نادرست می‌باشد. لطفا به مدیر تالار اطلاع دهید تا مشکل را حل کند.',
