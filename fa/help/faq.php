...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> 'با استفاده از این لیست میتوانید سایر کاربران تالار را سازمان دهی کنید. به کاربرانی که به لیست دوستانتان اضافه کرده باشید،دسترسی سریعی خواهید داشت و این کاربران به کنترل پنل کاربریتان اضافه خواهند شد تا وضعیت آنلاین و یا آفلاین بودن آنها را سریع تر ببینید و سریع تر به آنها پیام خصوصی بفرستید. بسته به قالب تالار ممکن است پست های دوستانتان درشت تر نشان داده شود. اگر کاربری را به لیست دشمنانتان اضافه کنید،هیچکدام از پست های این کاربران به شما نمایش داده نخواهند شد.',
	'HELP_FAQ_FRIENDS_BASIC_QUESTION'	=> 'لیست دوستان و دشمنان چیست ؟',
	'HELP_FAQ_FRIENDS_MANAGE_ANSWER'	=>  'به دو روش میتوانید کاربران را به لیست دوستانتان اضافه کنید، میتوانید کاربران را از لینکی که در نمایه آنها وجود دارد به لیست دوستان و یا دشمنان خود اضافه کنید. دوم،در کنترل پنل کاربری خود میتوانید به طور مستقیم با وارد کردن نام کاربری آنها را به لیست دوستان و یا دشمنانتان اضافه کنید. از همان صفحه میتوانید کاربران را از این دو لیست حذف کنید..',
	...
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'	=> 'اگر در بیش از یک گروه کاربری عضو هستید،در آن صورت رنگ و هویت شما فقط میتواند متعلق به یک گروه کاربری باشد و این ویژگی ها را گروه کاربری پیش‌فرض تایین میکند. ممکن است مدیر به شما سطح دسترسی تغییر گروه کاربری را داده باشد.',
	...
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_ANYMORE_ANSWER'	=> 'اولا از درستی گذرواژه و نام کاربریتان اطمینان حاصل کنید اگر آنها درست بودند، دو حالت ممکن است که رخ داده باشد : اگر پشتیبانی coppa فعال باشد و در طول ثبت نام سن خود را زیر 13 سال وارد کرده باشید باید دستور العمل هایی را که دریافت کرده اید دنبال کنید. بعضی از تالار ها برای فعال سازی خواهند خواست که دوباره ثبت نام کنید. یا توسط خودتان و یا توسط مدیر،قبل از اینکه بتوانید وارد شوید این اطلاعات در طول ثبت نام نمایش داده میشوند. اگر به شما ایمیلی ارسال شد، دستور العمل ها را دنبال کنید. اگر ایمیلی دریافت نکرده باشید ممکن است ایمیل وارد شده در حین ثبت نام نادرست باشد و یا ایمیل ارسالی توسط سرویس ایمیل دهنده هرزنامه (spam) شناخته شود. اگر از ایمیل وارد شده اطمینان دارید،لطفا با مدیر تالار تماس بگیرید.',
	...
	'HELP_FAQ_LOGIN_LOST_PASSWORD_ANSWER'	=> 'نگران نباشید! گذرواژه به راحتی قابل بازیابی است. به صفحه ورود رجوع کنید و بر روی <em>گذرواژهم را فراموش کرده ام</em>کلیک کنید. دستورالعمل ها را به دقت دنبال کنید،به زودی خواهید توانست که وارد شوید.',
	'HELP_FAQ_LOGIN_LOST_PASSWORD_QUESTION'	=> 'گذرواژهم را فراموش کرده ام!',
	'HELP_FAQ_LOGIN_REGISTER_ANSWER'	=>  'بعد از ثبت نام اولیه ایملی به شما ارسال شده است، گذرواژه و نام کاربریتان را کنترل کرده و دوباره امتحان کنید. ممکن است مدیر تالار اکانت شما را به دلایلی غیرفعال و یا حذف کرده باشد. Also, همچنین بسیاری از تالار ها کاربرانی را که مدت زیادی است غیر فعال هستند به طور خودکار حذف میکنند،اگر اینچنین است دوباره ثبت نام کنید و این بار فعالیت بیشتری را از خود نشان دهید.',
	'HELP_FAQ_LOGIN_REGISTER_CONFIRM_ANSWER'	=>  'اولا از درستی گذرواژه و نام کاربریتان اطمینان حاصل کنید اگر آنها درست بودند، دو حالت ممکن است که رخ داده باشد : اگر پشتیبانی coppa فعال باشد و در طول ثبت نام سن خود را زیر 13 سال وارد کرده باشید باید دستور العمل هایی را که دریافت کرده اید دنبال کنید. بعضی از تالار ها برای فعال سازی خواهند خواست که دوباره ثبت نام کنید. یا توسط خودتان و یا توسط مدیر،قبل از اینکه بتوانید وارد شوید این اطلاعات در طول ثبت نام نمایش داده میشوند. اگر به شما ایمیلی ارسال شد، دستور العمل ها را دنبال کنید. اگر ایمیلی دریافت نکرده باشید ممکن است ایمیل وارد شده در حین ثبت نام نادرست باشد و یا ایمیل ارسالی توسط سرویس ایمیل دهنده هرزنامه (spam) شناخته شود. اگر از ایمیل وارد شده اطمینان دارید،لطفا با مدیر تالار تماس بگیرید.',
	...
	'HELP_FAQ_PMS_UNWANTED_ANSWER'	=>  'میتوانید در کنترل پنل کاربری،در بخش قوانین پیام خصوصی از دریافت پیام خصوصی از جانب کاربر(ان) خاصی جلوگیری کنید. اگر این پیام ها را از جانب کاربر مشخصی دریافت میکنید، لطفا این موضوع را به مدیران اطلاع دهید،آنها میتوانند از ارسال این پیام ها توسط کاربری جلوگیری کنند.',
	...
	'HELP_FAQ_SEARCH_OWN_ANSWER'	=>  'میتوانید با کلیک بر روی "مشاهده پست های شما" پست های خودتان را ببینید و همچنین از نمایهتان نیز میتوانید بر پست هاتان دسترسی داشته باشید. برای جستجوی موضوعات میتوانید از صفحه جستجوی پیشرفته استفاده کنید و گزینه های مربوطه را تکمیل کنید.',
