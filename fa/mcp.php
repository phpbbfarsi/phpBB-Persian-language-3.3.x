...
$lang = array_merge($lang, array(
	...
	'APPROVE_POST_CONFIRM'	=> 'آیا از تأیید این پست مطمئن هستید؟',
	'APPROVE_POSTS'			=> 'تأیید پست ها',
	'APPROVE_POSTS_CONFIRM'	=> 'آیا از تأیید پست های انتخاب شده مطمئن هستید؟',
	'APPROVE_TOPIC'			=> 'تأیید موضوع',
	'APPROVE_TOPIC_CONFIRM'	=> 'آیا از تأیید این موضوع اطمینان دارید؟',
	'APPROVE_TOPICS'		=> 'تأیید موضوعات',
	'APPROVE_TOPICS_CONFIRM'=> 'آیا از تأیید موضوعات اطمینان دارید؟',
	...
	'CAN_LEAVE_BLANK'		=> 'میتوانید این قسمت را خالی بگذارید.',
	'CHANGE_POSTER'			=> 'تغییر ارسال کننده',
	'CLOSE_PM_REPORT'		=> 'بستن گزارش پیام خصوصی',
	'CLOSE_PM_REPORT_CONFIRM'	=> 'آیا از بستن گزارش پیام خصوصی انتخاب شده مطمئن هستید؟',
	'CLOSE_PM_REPORTS'		=> 'بستن گزارش های پیام خصوصی',
	'CLOSE_PM_REPORTS_CONFIRM'	=> 'آیا از بستن گزارش های پیام خصوصی انتخاب شده مطمئن هستید؟',
	...
	'DELETE_PM_REPORT_CONFIRM'	=> 'آیا از حذف گزارش پیام خصوصی انتخاب شده مطمئن هستید ؟',
	'DELETE_PM_REPORTS'			=> 'حذف گزارش های پیام خصوصی',
	'DELETE_PM_REPORTS_CONFIRM'	=> 'آیا از حذف گزارش های پیام خصوصی مطمئن هستید ؟',
	...
	'DISAPPROVE_POST_CONFIRM'	=> 'آیا از تأیید نکردن پست مطمئن هستید؟',
	'DISAPPROVE_POSTS'			=> 'عدم تأیید پست ها',
	'DISAPPROVE_POSTS_CONFIRM'	=> 'آیا از تأیید نکردن پست های انتخاب شده مطمئن هستید؟',
	...
	'LOCK_POST_POSTS_CONFIRM'	=> 'آیا از جلوگیری ویرایش همه پست های انتخاب شده مطمئن هستید؟',
	'LOCK_TOPIC_CONFIRM'		=> 'آیا از قفل کردن این موضوع مطمئن هستید؟',
	'LOCK_TOPICS'				=> 'قفل کردن موضوعات انتخاب شده',
	'LOCK_TOPICS_CONFIRM'		=> 'آیا از قفل کردن همه موضوعات انتخاب شده مطمئن هستید؟',
	...
	'MCP_MAKE_STICKY_CONFIRM'		=> 'آیا از "سنجاق" کردن موضوع مطمئن هستید؟',
	'MCP_MAKE_STICKIES'				=> '"سنجاق" کردن',
	'MCP_MAKE_STICKIES_CONFIRM'		=> 'آیا از "سنجاق" کردن موضوعات مطمئن هستید؟',
	...
	'MCP_PM_REPORTS_CLOSED'			=> 'گزارش پیام های بسته',
	'MCP_PM_REPORTS_CLOSED_EXPLAIN'	=> 'این لیستی از همه پیام های خصوصی گزارش شده میباشد، که مسائل مربوط به آن‌ها حل شده است.',
	'MCP_PM_REPORTS_OPEN'			=> 'گزارش پیام های خصوصی باز',
	'MCP_PM_REPORTS_OPEN_EXPLAIN'	=> 'این لیستی از همه پیام های خصوصی گزارش شده میباشد، که مسائل مربوط به آن‌ها حل نشده است.',

	'MCP_REPORTS'					=> 'پیام های گزارش شده',
	'MCP_REPORT_DETAILS'			=> 'جزئیات گزارش',
	'MCP_REPORTS_CLOSED'			=> 'گزارش های بسته شده',
	'MCP_REPORTS_CLOSED_EXPLAIN'	=> 'این لیستی از همه گزارش هایی میباشد که اخیرا حل شده اند.',
	'MCP_REPORTS_OPEN'				=> 'گزارش های باز',
	'MCP_REPORTS_OPEN_EXPLAIN'		=> 'این لیستی از همه گزارش هایی میباشد که هنوز حل نشده اند.',

	'MCP_QUEUE'								=> 'لیست انتظار',
	'MCP_QUEUE_APPROVE_DETAILS'				=> 'جزئیات تأیید',
	'MCP_QUEUE_UNAPPROVED_POSTS'			=> 'پست های در انتظار تأیید',
	'MCP_QUEUE_UNAPPROVED_POSTS_EXPLAIN'	=> 'این لیستی از پست هایی میباشد که منتظر تأیید شدن هستند تا به کاربران نمایش داده شوند.',
	'MCP_QUEUE_UNAPPROVED_TOPICS'			=> 'موضوعاتی که منتظر تأیید هستند',
	'MCP_QUEUE_UNAPPROVED_TOPICS_EXPLAIN'	=> 'این لیستی از موضوعات میباشد که منتظر تأیید شدن هستند تا به کاربران نمایش داده شوند.',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'با استفاده از فرم زیر میتوانید پست های انتخاب شده را در موضوعی دیگر ادغام کنید. توجه داشته باشید که این پست ها بازسازی نخواهند شد و کاربران پست های خودشان را در موضوعی جدید خواهند دید.<br />لطفا ID موضوع مقصد را وارد کنید و یا با کلیک بر روی "انتخاب موضوع" موضوعی را جست‌وجو کنید.',
	...
	'POSTS_DISAPPROVED_SUCCESS'	=> 'پست های انتخاب شده با موفقیت تأیید نشدند.',
	...
	'POST_DISAPPROVED_SUCCESS'	=> 'پست انتخاب شده با موفقیت تأیید نشد.',
	...
	'SPLIT_TOPIC_EXPLAIN'				=> 'با استفاده از فرم زیر میتوانید موضوع را تقسیم کنید.',
	...
	'TOPICS_DISAPPROVED_SUCCESS'=> 'موضوعات انتخاب شده با موفقیت تأیید نشدند.',
	...
	'TOPIC_DISAPPROVED_SUCCESS'	=> 'موضوع انتخاب شده با موفقیت تأیید نشد.',
