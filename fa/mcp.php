...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'اگر میخواهید برای این گزارشی را بنویسید، لطفاً فرم زیر را تکمیل فرمایید. فقط از متن ساده استفاده کنید، استفاده از HTML،BBCode و ... مورد قبول نیست.',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'با استفاده از فرم زیر می‌توانید پست‌های انتخاب شده را در موضوعی دیگر ادغام کنید. توجه داشته باشید که این پست‌ها بازسازی نخواهند شد و کاربران پست‌های خودشان را در موضوعی جدید خواهند دید.<br />لطفاً ID موضوع مقصد را وارد کنید و یا با کلیک بر روی "انتخاب موضوع" موضوعی را جست‌وجو کنید.',
	...
	'NO_DESTINATION_FORUM'			=> 'لطفاً انجمن مقصد را انتخاب کنید.',
	...
	'NO_REASON_DISAPPROVAL'			=> 'لطفاً دلیل مناسبی را برای عدم تأیید وارد کنید.',
	...
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENT'	=> 'لطفاً انجمنی را که میخواهید این پیام سراسری در آن نمایش داده شود را انتخاب کنید.',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENTS'	=> 'یک یا چند موضوع انتخاب شده،اطلاعیه سراسری هستند.لطفاً انجمنی را که میخواهید این اطلاعیه سراسری نمایش داده شود،انتخاب کنید.',
