...
$lang = array_merge($lang, array(
	...
	'MCP_QUEUE_DELETED_POSTS_EXPLAIN'		=> 'این لیستی از پست ها حذف شده موقت است، که شما می‌توانید آن‌ها را بازیابی کنید یا برای همیشه حذف کنید.',
	'MCP_QUEUE_DELETED_TOPICS'				=> 'موضوعات حذف شده',
	'MCP_QUEUE_DELETED_TOPICS_EXPLAIN'		=> 'این لیستی از موضوعات حذف شده موقت است، که شما می‌توانید آن‌ها را بازیابی کنید یا برای همیشه حذف کنید.',
