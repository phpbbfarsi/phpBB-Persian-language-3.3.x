...
$lang = array_merge($lang, array(
	...
	'MAX_NUM_SEARCH_KEYWORDS_REFINE'	=> array(
		1	=> 'برای جست‌وجو کلمات زیادی را تایین کرده اید.حداکثر %1$d کلمه میتوانید وارد کنید.',
		2	=> 'برای جست‌وجو کلمات زیادی را تایین کرده اید.حداکثر %1$d کلمه میتوانید وارد کنید.',
	),
	...
	'NO_SEARCH'				=> 'متاسفیم، نمیتوانید از بخش جست‌وجو استفاده کنید.',
	...
	'NO_SEARCH_TIME'		=> array(
		1	=> 'در حال حاضر نمیتوانید جست‌وجویی را انجام دهید،لطفا بعد از چند دقیقه دوباره امتحان کنید.',
		2	=> 'در حال حاضر نمیتوانید جست‌وجویی را انجام دهید،لطفا بعد از چند دقیقه دوباره امتحان کنید.',
	),
