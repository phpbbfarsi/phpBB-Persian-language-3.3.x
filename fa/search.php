...
$lang = array_merge($lang, array(
	...
	'FOUND_SEARCH_MATCHES'		=> array(
		1	=> 'نتایج هماهنگ با عبارت جستجو شده : %d',
		2	=> 'نتایج هماهنگ با عبارت جستجو شده : %d',
	),
	...
	'NO_KEYWORDS'			=> 'برای جستجو باید حداقل یک کلمه را انتخاب کنید. هر کلمه باید حداقل دارای %s نویسه باشد و نویسه های بیشتر از %s مورد قبول نخواهد بود.',
	'NO_RECENT_SEARCHES'	=> 'اخیرا جستجو ای صورت نگرفته است.',
	'NO_SEARCH'				=> 'متاسفیم، نمیتوانید از بخش جستجو استفاده کنید.',
	'NO_SEARCH_RESULTS'		=> 'نتیجه مناسبی یافت نشد.',
	'NO_SEARCH_LOAD'		=> 'متاسفیم، در حال حاضر امکان جستجو برای شما وجود ندارد. بارگزاری سرور بسیار سنگین شده است ، لطفا مجدد تلاش نمایید.',
	...
	'NO_SEARCH_UNREADS'		=> 'متاسفیم، جستجوی پست های خوانده نشده در این تالار غیرفعال شده است.',
	...
	'PHRASE_SEARCH_DISABLED'	=> 'جستجو بر اساس عبارت دقیق در این انجمن پشتیبانی نمی شود.',
	...
	'GO_TO_SEARCH_ADV'	        => 'رفتن به جستجوی پیشرفته',
	...
	'SPHINX_SEARCH_FAILED_LOG'	=> 'متاسفیم، امکان جستجو وجود ندارد.جهت اطلاعات بیشتر درباره این موضوع باید وارد حساب خود شوید.',
