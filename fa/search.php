...
$lang = array_merge($lang, array(
	...
	'NO_SEARCH_LOAD'		=> 'متاسفیم، در حال حاضر امکان جست‌وجو برای شما وجود ندارد. بارگزاری سرور بسیار سنگین شده است ، لطفاً مجدد تلاش نمایید.',
	'NO_SEARCH_TIME'		=> array(
		1	=> 'در حال حاضر نمی‌توانید جست‌وجویی را انجام دهید،لطفاً بعد از چند دقیقه دوباره امتحان کنید.',
		2	=> 'در حال حاضر نمی‌توانید جست‌وجویی را انجام دهید،لطفاً بعد از چند دقیقه دوباره امتحان کنید.',
	),
	...
	'SEARCH_AUTHOR_EXPLAIN'		=> 'اگر کلمه وارد شده قسمتی از نتیجه احتمالی است، لطفاً * را وارد کنید.',
