...
$lang = array_merge($lang, [
	...
	'RECAPTCHA_V3_LOGIN_ERROR_ATTEMPTS'	=> 'شما بیشتر از حداکثر تعداد مجاز ورود به سیستم تلاش کرده اید.<br>علاوه بر نام کاربری و کلمه عبور، از ریکپچا ورژن۳ نامرئی برای تأیید اعتبار جلسه شما استفاده خواهد شد.',
