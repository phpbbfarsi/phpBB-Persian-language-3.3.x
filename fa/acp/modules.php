...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'در این اینجا شما می‌توانید همه گونه های ماژولی را اداره کنید. لطفاً در نظر داشته باشید که ماژول های بخش مدیریت ، ساختار سه مرحله ای دارند (دسته -> دسته -> ماژول) ماژول های بخش های دیگر ساختار دو مرحله ای دارند (دسته -> ماژول). لطفاً همچنین آگاه باشید که شما می‌توانید با غیرفعال یا حذف کردن ماژول های معتبر و حیاتی خود را در تنگنا قرار دهید .',
	...
	'CANNOT_REMOVE_MODULE'	=> 'ناتوانی در حذف ماژول, این ماژول زیر گروه‌هایی دارد. لطفاً پیش از حذف ماژول زیر گروه‌ها را منتقل یا حذف کنید.',
	'CATEGORY'				=> 'دسته',
