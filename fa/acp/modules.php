...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'در این اینجا شما می توانید همه گونه های ماژولی را اداره کنید. لطفا در نظر داشته باشید که ماژول های بخش مدیریت ، ساختار سه مرحله ای دارند (دسته -> دسته -> ماژول) ماژول های بخش های دیگر ساختار دو مرحله ای دارند (دسته -> ماژول). لطفا همچنین آگاه باشید که شما می توانید با غیر فعال یا حذف کردن ماژول های معتبر و حیاتی خود را در تنگنا قرار دهید .',
	'ADD_MODULE'					=> 'افزودن ماژول',
	'ADD_MODULE_CONFIRM'			=> 'آیا از افزودن ماژول انتخاب شده با حالت برگزیده اطمینان دارید ؟',
	...
	'DEACTIVATED_MODULE'	=> 'ماژول غیر فعال شده',
	'DELETE_MODULE'			=> 'حذف ماژول',
	'DELETE_MODULE_CONFIRM'	=> 'آیا از حذف ماژول اطمینان دارید ؟',
