...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_MIN_SEARCH_CHARS_EXPLAIN'	=> 'کلماتی حداقل با این تعداد کاراکتر در جست‌وجو ها محسوب خواهند شد،این تعداد کاراکتر از تنظیمات پیکربندی MYSQL قابل تغییر است.',
	'FULLTEXT_MYSQL_MAX_SEARCH_CHARS_EXPLAIN'	=> 'کلماتی که بیشتر از این تعداد کاراکتر باشند در جست‌وجو ها محسوب خواهند شد،این رقم از تنظیمات پیکربندی MYSQL قابل تغییر است.',
	...
	'MAX_SEARCH_CHARS'						=> 'حداکثر تعداد کاراکتر کلمات برای شاخص بندی شدن در جست‌وجو',
	'MAX_SEARCH_CHARS_EXPLAIN'				=> 'کلماتی که بیشتر از این تعداد کاراکتر نباشند،در جست‌وجو شاخص بندی خواهند شد.',
	...
	'MIN_SEARCH_CHARS'						=> 'حداقل تعداد کاراکتر کلمات برای شاخص بندی شدن در جست‌وجو',
	'MIN_SEARCH_CHARS_EXPLAIN'				=> 'کلماتی که کمتر از ایت تعداد کاراکتر باشند در جست‌وجو شاخص بندی خواهند شد.',
	'MIN_SEARCH_AUTHOR_CHARS'				=> 'حداقل تعداد کاراکتر برای جست‌وجوی نام نویسنده',
	'MIN_SEARCH_AUTHOR_CHARS_EXPLAIN'		=> 'در جست‌وجوی قسمتی از نام نویسنده کاربر باید حداقل این تعداد کاراکتر را وارد کند،اگر نام نویسنده ای کوتاه تر از این تعداد کاراکتر باشد باز هم اگر نام کامل وی در جست‌وجو درج شود،پست های او نمایش داده خواهند شدو',
	...
	'SEARCH_STORE_RESULTS'					=> 'درازای cache برای نتایج جست‌وجو',
	'SEARCH_STORE_RESULTS_EXPLAIN'			=> 'cache نتایج جست‌وجو بعد از این مدت زمان (ثانیه) حذف خواهد شد،برای غیرفعال کردن این ویژگی 0 را وارد کنید.',
	'SEARCH_TYPE'							=> 'مرجع جست‌وجو',
	'SEARCH_TYPE_EXPLAIN'					=> 'phpBB به شما این اجازه را می دهد تا مرجع جست‌وجوی خود را انتخاب کنید،به صورت پیشفرض از مرجع جست‌وجوی متنی phpBB استفاده می شود.',
	...
	'YES_SEARCH_UPDATE_EXPLAIN'				=> 'هنگام ارسال پست های جدید،شاخص جست‌وجو را بروزرسانی می کند،اگر جست‌وجو غیرفعال باشد این گزینه عملکردی نخواهد داشت.',
));
