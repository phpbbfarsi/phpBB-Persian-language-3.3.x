...
$lang = array_merge($lang, array(
	...
	'LIMIT_SEARCH_LOAD_EXPLAIN'				=> 'اگر بارگذاری صفحه جست‌وجو بیش از 1 دقیقه طول بکشد،صفحه برون‌خط خواهد شد. 1.0 معادل 100% مصرف یک پردازنده می باشد. این عملکرد فقط در سرور های UNIX فعال است.',
