...
$lang = array_merge($lang, array(
	...
	'ADD_USERS_EXPLAIN'				=> 'در این گزینه میتوایند کاربران را به گروه اضافه کنید،تعیین کنید که آیا گروه برای کاربران انتخاب شده پیش‌فرض باشد و یا نه و یا رهبران گروه را مشخص کنید. لطفا هر نام کاربری را در سطر جداگانه ای وارد کنید.',
	...
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'آیا از اضافه کردن %2$s به گروه مطمئن هستید؟',
		2	=> 'آیا از اضافه کردن کاربران %2$s به گروه مطمئن هستید؟',
	),
	...
	'GROUP_RECEIVE_PM_EXPLAIN'		=> 'لطفا توجه داشته باشید که گروه های مخفی در هر شرایطی نمی توانند پیام خصوصی دریافت کنند.',
