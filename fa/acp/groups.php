...
$lang = array_merge($lang, array(
	...
	'ADD_USERS_EXPLAIN'				=> 'در این گزینه میتوایند کاربران را به گروه اضافه کنید،تعیین کنید که آیا گروه برای کاربران انتخاب شده پیش‌فرض باشد و یا نه و یا رهبران گروه را مشخص کنید. لطفاً هر نام کاربری را در سطر جداگانه ای وارد کنید.',
	...
	'GROUP_COLOR_EXPLAIN'			=> 'رنگی را مشخص می کند که نام کاربری کاربر پس از عضویت در گروه در آن رنگ نمایش داده خواهد شد،برای حالت پیش‌فرض این فیلد را خالی بگزارید.',
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'آیا از اضافه کردن %2$s به گروه مطمئنید؟',
		2	=> 'آیا از اضافه کردن کاربران %2$s به گروه مطمئنید؟',
	),
	'GROUP_CREATED'					=> 'گروه با موفقیت ایجاد شد',
	'GROUP_DEFAULT'					=> 'گروه برای اعضا پیش‌فرض باشد',
	'GROUP_DEFS_UPDATED'			=> 'گروه پیش‌فرض برای تمامی تعضای انتخاب شده تنظیم شد.',
	'GROUP_DELETE'					=> 'حذف عضو از گروه',
	'GROUP_DELETED'					=> 'گروه حذف و گروه پیش‌فرض کاربری با موفقیت تنظیم شد',
	'GROUP_DEMOTE'					=> 'تنزل رتبه ی رهبر گروه',
	'GROUP_DESC'					=> 'توضیحات گروه',
	'GROUP_DETAILS'					=> 'جزئیات گروه',
	'GROUP_EDIT_EXPLAIN'			=> 'در این بخش می‌توانید گروه‌های موجود را ویرایش کنید، نام،توضیحات گروه را وارد کرده و حالت(باز،بسته و...) آن را مشخص کنید. همچنین می‌توانید تنظیمات مربوط به گروه مشخصی مانند رنگ و رتبه و ... را تنظیم کنید. از دیگر امکانات این بخش اعمال تنظیم بر روی کاربران می باشد،لطفاً توجه داشته باشید که تا زمانی که سطوح دسترسی مشخصی تعریف نشود، اعضای گروه می توانند آواتار گروه را برای خود تغییر دهند.',
	...
	'GROUP_MEMBERS_EXPLAIN'			=> 'این لیست کاملی از تمامی اعضای این گروه می باشد. بخش مجزایی برای رهبران گروه و کاربران مورد انتظار و اعضا موجود است. از این بخش می‌توانید به تمامی کاربران نظارت و نقش ها آنان را تعیین کنید،برای این که رهبری را از رهبری حذف کنید می‌توانید او را تنزیل رتبه دهید که در این حالت عضو تنزیل رتبه شده از رتبه رهبری برکنار خواهد شد ولی همچنان در گروه عضو خواهد بود.در حالت برعکس این مورد، می‌توانید عضوی را ارتقاء رتبه دهید و وی را به عنوان رهبر گروه تعیین کنید.',
	'GROUP_MESSAGE_LIMIT'			=> 'محدودیت پیام خصوصی گروه در هر پوشه',
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'این گزینه محدودیت موجود در تعداد پیام خصوصی موجود در هر پوشه را تغییر خواهد داد. حداکثر برای همه گروه‌های کاربر مقدار واقعی تعیین میشود<br />با تعیین مقدار 0 تنظیمات به صورت تنظیمات پیش‌فرض تالار خواهد بود.',
	...
	'GROUP_NAME'					=> 'نام گروه',
	'GROUP_NAME_TAKEN'				=> 'گروهی با این نام وجود دارد،لطفاً نام وارد شده را تغییر دهید.',
	'GROUP_OPEN'					=> 'باز',
	'GROUP_PENDING'					=> 'مورد انتظار عضویت',
	'GROUP_MAX_RECIPIENTS'			=> 'حداکثر تعداد گیرنده در هر پیام خصوصی',
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'مشخص کننده حداکثر تعداد گیرنده در هر پیام خصوصی می باشد.  حداکثر برای همه گروه‌های کاربر مقدار واقعی تعیین میشود.<br />با تعیین مقدار 0 تنظیمات به صورت تنظیمات پیش‌فرض تالار خواهد بود.',
	'GROUP_OPTIONS_SAVE'			=> 'گزینه‌های گروه',
	'GROUP_PROMOTE'					=> 'ارتقاء به رهبری گروه',
	'GROUP_RANK'					=> 'رتبه گروه',
	'GROUP_RECEIVE_PM'				=> 'گروه می تواند پیام خصوصی دریافت کند.',
	'GROUP_RECEIVE_PM_EXPLAIN'		=> 'لطفاً توجه داشته باشید که گروه‌های مخفی در هر شرایطی نمی توانند پیام خصوصی دریافت کنند.',
	...
	'GROUP_UPDATED'					=> 'تنظیمات گروه با موفقیت به‌روز رسانی شدند.',
	...
	'MAKE_DEFAULT_FOR_ALL'	=> 'پیش‌فرض کردن گروه به تمامی اعضا',
	'MEMBERS'				=> 'اعضا',
	...
	'SPECIAL_GROUPS_EXPLAIN'	=> 'گروه‌های از پیش مشخص شده گروه‌هایی ویژه میباشند که نمی‌توانید آن‌ها را ویرایش کنید و یا تغییر دهید.با این وجود می‌توانید کاربرانی را به این گروه‌ها اضافه کنید و یا تنظیمات ابتدایی آن‌ها را تغییر دهید.',
	...
	'USERS_APPROVED'				=> 'اعضا با موفقیت پذیرفته شدند',
	...
	'USER_GROUP_DEFAULT'			=> 'به عنوان گروه پیش‌فرض انتخاب شود',
	'USER_GROUP_DEFAULT_EXPLAIN'	=> 'اگر بله را انتخاب کنید،این گروه،گروه پیش‌فرض برای اعضا خواهد بود.',
