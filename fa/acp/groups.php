...
$lang = array_merge($lang, array(
	...
	'ADD_USERS_EXPLAIN'				=> 'در این گزینه میتوایند کاربران را به گروه اضافه کنید،تایین کنید که آیا گروه برای کاربران انتخاب شده پیش‌فرض باشد و یا نه و یا رهبران گروه را مشخص کنید. لطفا هر نام کاربری را در سطر جداگانه ای وارد کنید.',
