...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'این گزینه محدودیت موجود در تعداد پیام خصوصی موجود در هر پوشه را تغییر خواهد داد. حداکثر برای همه گروه های کاربر مقدار واقعی تعیین میشود<br />با تعیین مقدار 0 تنظیمات به صورت تنظیمات پیشفرض تالار خواهد بود.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'مشخص کننده حداکثر تعداد گیرنده در هر پیام خصوصی می باشد.  حداکثر برای همه گروه های کاربر مقدار واقعی تعیین میشود.<br />با تعیین مقدار 0 تنظیمات به صورت تنظیمات پیشفرض تالار خواهد بود.',
