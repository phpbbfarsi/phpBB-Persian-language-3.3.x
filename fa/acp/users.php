...
$lang = array_merge($lang, array(
	...
	'CANNOT_FORCE_REACT_BOT'		=> 'نمی توانید روبات ها را مجبور به فعال سازی مجدد اکانتشان کنید،لطفا برای فعال سازی آن‌ها به صفحه مربوطه ربات ها رجوع کنید.',
	...
	'CANNOT_REMOVE_FOUNDER'			=> 'نمی‌توانید اکانت مدیر کل انجمن را حذف کنید.',
