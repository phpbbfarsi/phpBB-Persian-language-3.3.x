...
// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'این بخش موضوعاتی را که برای تعداد روز های مشخص شده بازدیدی نداشته باشند و یا پستی در آن‌ها ارسال نشود،حذف می کند. اگر عددی را وارد نکنید همگی موضوعات حذف خواهند شد. به صورت پیش‌فرض موضوعات نظرسنجی دار،مهم،اعلامیه دار هرس نمی شوند.',
