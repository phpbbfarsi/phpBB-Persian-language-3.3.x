...
$lang = array_merge($lang, array(
	...
	'PRUNE_USERS_LIST_DELETE'		=> 'با معیار های مشخص شده توسط شما حساب های مقابل حذف شدند.',
	'PRUNE_USERS_LIST_DEACTIVATE'	=> 'با معیار های مشخص شده توسط شما حساب های مقابل غیرفعال شدند.',

	'SELECT_USERS_EXPLAIN'		=> 'لطفاً نام کاربری مشخصی را وارد کنید.این نام های کاربری بر معیار های هرس اولویت خواهند داشت،صاحب امتیاز سایت نمی تواند هرس شود.',
...
// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'این بخش موضوعاتی را که برای تعداد روزهای مشخص شده بازدیدی نداشته باشند و یا پستی در آن‌ها ارسال نشود،حذف می کند. اگر عددی را وارد نکنید همگی موضوعات حذف خواهند شد. به صورت پیش‌فرض موضوعات نظرسنجی دار،مهم،اعلامیه دار هرس نمی شوند.',
