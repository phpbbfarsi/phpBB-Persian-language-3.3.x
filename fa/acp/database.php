...
$lang = array_merge($lang, array(
	...
	'ACP_RESTORE_EXPLAIN'	=> 'در این بخش می‌توانید از اطلاعات تالاتان پشتیبان تهیه کنید که این پشتیبان در آدرس <samp>store/</samp> ذخیر میشود. با توجه به شرایط  سرور می‌توانید آن را با فرمت های مختلف فشرده سازی کنید.',
