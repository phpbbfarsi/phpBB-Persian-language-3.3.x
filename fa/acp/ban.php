...
$lang = array_merge($lang, array(
	...
	'IP_BAN_EXPLAIN'			=> 'برای مشخص کردن چند IP و یا hostname هر کدام از آن‌ها را در سطر های جداگانه وارد کنید. برای مشخص کردن بازه ای از IP ها، IP اولی و آخری را با خط تیره (-) مشخص کنید. برای مشخص کردن کلمات از (*) استفاده کنید.',
	...
	'USER_BAN_EXPLAIN'			=> 'برای وارد کردن چندین نام کاربری، هر یک را در سطر جداگانه ای وارد کنید. از <span style="text-decoration: underline;">جست‌وجوی کاربران</span> برای یافتن نام های کاربری کاربران استفاده کنید.',
