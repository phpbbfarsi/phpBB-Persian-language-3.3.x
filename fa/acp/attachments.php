...
$lang = array_merge($lang, array(
	...
	'ACP_MANAGE_EXTENSIONS_EXPLAIN'		=> 'در این اینجا شما می‌توانید همه پسوند های فعال را اداره کنید. برای فعال سازی پسوندتان, لطفاً به قاب "مدیریت گروه پسوندها" رجوع فرمایید. ما شدیدا به شما توصیه می کنیم که پسوند های اسکریپتی را فعال نکنید (مثال از این قبیل <code>php</code>, <code>php3</code>, <code>php4</code>, <code>phtml</code>, <code>pl</code>, <code>cgi</code>, <code>py</code>, <code>rb</code>, <code>asp</code>, <code>aspx</code>, و ...).',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'حداکثر ابعاد تصاویر پیوستی. phpBB ممکن است قبل از بارگذاری، تصاویر را به طور خودکار تا این حداکثر ابعاد تصویر تغییر اندازه دهد. هر دو مقدار را روی 0px در 0px قرار دهید تا بررسی ابعاد و تغییر اندازه خودکار غیرفعال شود.',
	...
	'NO_WRITE_UPLOAD'			=> 'دایرکتوری upload قابل نوشتن نیست،لطفاً سطوح دسترسی آن را تغییر دهید تا سرور بتواند بر روی آن بنویسد.',
	...
	'UPLOADING_FILE_TO'				=> 'در حال بارگزاری فایل “%1$s”  برای پست %2$d ...',
	'UPLOAD_DENIED_FORUM'			=> 'سطح دسترسی بارگذاری فایل به “%s” را ندارید.',
	'UPLOAD_DIR'					=> 'دایرکتوری بارگذاری',
	'UPLOAD_DIR_EXPLAIN'			=> 'مسیر ذخیره پیوست‌ها. لطفاً توجه داشته باشید که اگر این مسیر را تغییر دهید،باید فایل‌های پیوست کنونی را به صورت دستی به مسیر جدید انتقال دهید.',
	'UPLOAD_ICON'					=> 'آیکون بارگذاری',
	'UPLOAD_NOT_DIR'				=> 'محل مشخص شده برای بارگذاری به نظر نمی رسد که یک دایرکتوری باشد.',
    'UPLOAD_POST_NOT_EXIST'			=> 'فایل “%1$s” نمیتوانید برای پست %2$d بارگزاری شود ، زیرا این پست دیگر وجود ندارد.',
));
