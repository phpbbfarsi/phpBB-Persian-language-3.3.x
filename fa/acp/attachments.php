...
$lang = array_merge($lang, array(
	...
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'در این قسمت شما می توانید گروه های پسوندی را اضافه, حذف, ویرایش و یا غیر فعال کنید. گزینه های بیشتر در شاخه های ویژه آن‌ها قرار دارد.تغییر مکانیزم دانلود و تعیین یک آیکون برای نمایش در جلوی پیوست برای تشخیص هویت از این گزینه ها محسوب می شوند.',
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'حد اکثر حجم هر فایل, با 0 مقداردهی می شود، به وسیله تنظیمات پیکربندی PHP می توانید اندازه فایل های آپلود را محدودسازی نمایید.',
	...
	'CHECK_CONTENT_EXPLAIN'		=> 'بعضی از مرورگر ها ممکن هست دچار اشتباه شوند و آپلود بعضی از فایل های نامجاز را که نوع فرمت آن‌ها (mimetype) تغییر یافته است،قبول کنند. این گزینه باعث اطمینان از این نوع فایل ها خواهد شد.',
	...
	'EXCLUDE_FROM_DISALLOWED_IP'	=> 'مستثنی کردن کردن IP از IP/HostName های غیر فعال',
	...
	'IMAGE_QUALITY'				=> 'کیفیت عکس های آپلود شده در پیوست ( فقط JPEG )',
	'IMAGE_QUALITY_EXPLAIN'		=> 'تعیین مقدار بین 50%  (اندازه فایل کوچکتر) تا 9% (کیفیت بالاتر). کیفیت بالاتر از  90% باعث افزایش حجم فایل میشود و غیر فعال خواهد بود. تنظیم فقط درصورتی اعمال می شود که حداکثر ابعاد تصویر به مقداری غیر از 0px توسط 0px روی مقداری تنظیم شود.',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'دگرگون سازی رفتار پیش‌فرض هنگامی فعال بودن دانلود ایمن در لیست پذیریش/عدم پذیریش و دربرابر آن یک <strong>لیست سفید</strong> ( فعال ) و یک <strong>لیست سیاه</strong> غیر فعال.',
	...
	'SUCCESSFULLY_UPLOADED'			=> 'با موفقیت آپلود شد.',
