...
$lang = array_merge($lang, array(
	'ACP_ATTACHMENT_SETTINGS_EXPLAIN'	=> 'در این قسمت شما می توانید تنظیمات پیشفرض پیوست ها و همچنین شاخه های ویژه را پیکربندی نمایید.',
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'در این قسمت شما می توانید گروه های پسوندی را اضافه, حذف, ویرایش و یا غیر فعال کنید. گزینه های بیشتر در شاخه های ویژه آنها قرار دارد.تغییر مکانیزم دانلود و تعیین یک آیکون برای نمایش در جلوی پیوست برای تشخیص هویت از این گزینه ها محسوب می شوند.',
	...
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'حداكثر حجم هر فایل ضمیمه شده در پیام های خصوصی. مقدار 0 یعنی بدون محدودیت',
	...
	'SECURE_DOWNLOAD_UPDATE_SUCCESS'=> 'لیست IP با موفقیت بروز رسانی شد.',
