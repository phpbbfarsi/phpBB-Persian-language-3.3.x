...
$lang = array_merge($lang, array(
	...
	'ACP_SMILIES_EXPLAIN'	=> 'شکلکک‌ها تصاویر کوچکی می باشند که احساسات کاربران را نشان می دهند،در این بخش می توانید این شکلکک‌ها را که در پست‌ها و پیام‌های خصوصی مورد استفاده قرار می گیرند،ویرایش،حذف و اضافه کنید.',
	...
	'CURRENT_SMILIES'			=> 'شکلکک‌های کنونی',
	'CURRENT_SMILIES_EXPLAIN'	=> 'لطفا انتخاب کنید که چه عملیاتی بر روی شکلکک‌های نصب شده انجام گیرد.',
	...
	'EXPORT_SMILIES_EXPLAIN'	=> '%sاگر بر روی این لینک کلیک کنید،پیکربندی بسته شکلکک‌ها در <samp>icons.pak</samp> ذخیره خواهد شد و بعد از بارگیری می توانید آن را در آرشیو <samp>.zip</samp> یا <samp>.tgz</samp> قرار دهید که هم حاوی فایل پیکربندی <samp>icons.pak</samp> و هم خود شکلکک‌ها می باشد.%s.',
	...
	'IMPORT_SMILIES'		=> 'نصب بسته شکلکک‌ها',
	...
	'SMILIES_ADDED'				=> array(
		...
		2	=> 'شکلکک‌ها با موفقیت اضافه شدند.',
	),
	...
	'SMILIES_EDITED'			=> array(
		...
		2	=> 'شکلکک‌ها با موفقیت به‌روز رسانی شدند.',
	),
	...
	'SMILIES_NOT_DISPLAYED'		=> 'شکلکک‌های مقابل در صفحه ارسالات نمایش داده نمی شوند.',
...
$lang = array_merge($lang, array(
	...
	'NO_UPDATE_RANKS'		=> 'رتبه با موفقیت حذف شد،با این وجود رتبه در اکانت کاربران به‌روز رسانی نشده است و این کار را باید دستی انجام دهید.',
