...
$lang = array_merge($lang, array(
	...
	'BOTS_EXPLAIN'		=> '"Bot ها" ، "spider ها" و "crawler ها" ماموران عمومی موتور های جست‌وجو برای بروز رسانی دیتابیس آنها هستند. از این رو آنها با استفاده ای نامناسب از session ها می توانند شمارش بازدیدها را ناهموار کنند. به این خاطر بارگذاری و برخی چیزهای دیگر در صفحه فهرست سایت بخوبی با موافقت روبرو نخواهد شد. از اینجا شما می توانید حالت های ویژه ای را برای غلبه بر این مشکلات تعریف کنید.',
