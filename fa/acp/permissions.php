...
$lang = array_merge($lang, array(
	...
	'ACP_FORUM_MODERATORS_EXPLAIN'	=> 'در اینجا شما می‌توانید کاربران و گروه‌ها را بعنوان مدیرانجمن مقرر کنید. برای بهره مند کردن کاربران از دسترسی, لطفاً به صفحات مناسب با سطوح دسترسی مدیر کل یا مدیر کلی انجمن‌ها مراجعه کنید.',
	'ACP_FORUM_PERMISSIONS_EXPLAIN'				=> 'در اینجا می‌توانید تعیین کنید که چه کاربرانی به چه انجمن‌هایی دسترسی داشته باشند. برای مشخص کردن مدیران انجمن‌ها و یا مدیران لطفاً به صفحه مورد نظر مراجعه کنید.',
	...
	'NO_ROLE_NAME_SPECIFIED'	=> 'لطفاً برای نقش نامی را تعریف کنید.',
	'NO_ROLE_SELECTED'			=> 'نقش یافت نشد.',
	'NO_USER_GROUP_SELECTED'	=> 'هیچ کاربر و یا گروهی را مشخص نکرده اید.',

	'ONLY_FORUM_DEFINED'	=> 'در انتخابتان فقط انجمنی را انتخاب کرده اید،لطفاً نام کاربری و یا گروهی را نیز مشخص کنید.',
