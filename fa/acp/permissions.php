...
$lang = array_merge($lang, array(
	...
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'در اینجا می توانید سطوح دسترسی سراسری را برای کاربران - سطوح دسترسی کاربران،سطوح دسترسی مدیران انجمن ها و سطوح دسترسی مدیران مشخص کنید.   سطوح دسترسی کاربران شامل توانایی استفاده از آواتار،پیام خصوصی و ... ، سطوح دسترسی مدیران انجمن ها شامل تایید پست ها،تایید موضوعات،مدیریت تحریم ها و ... و در نهایت سطوح دسترسی مدیران شامل شامل مدیریت سطوح دسترسی،مدیریت BBCode ها،مدیریت انجمن ها و ... می باشد. سطوح دسترسی کاربران مختلف باید در موارد نادر تغییر کند. روش توصیه شده این است که کاربران را در گروه های مختلف قرار دهید و سپس سطوح دسترسی گروه را مناسب با کاربران عضو تنظیم کنید.',
	...
	'ROLE_DESCRIPTION_FORUM_BOT'			=> 'این نقش برای روبات ها و عنکبوت های موتور های جست‌وجو توصیه می شود.',
