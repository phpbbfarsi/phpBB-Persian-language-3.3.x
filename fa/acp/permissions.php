...
$lang = array_merge($lang, array(
	...
	'TRACE_DEFAULT'					=> 'به طور پیش‌فرض همه سطوح دسترسی <samp>نه</samp>هستند (انتخاب نشده). بنابراین سطوح دسترسی می توانند تحت تأثیر سایر تنظیمات تغییر یابند.',
	...
	'TRACE_USER_NO_TOTAL_NO'				=> 'سطوح دسترسی کاربر <samp>نه</samp> می باشد و داده مجموع نه می باشد،بنابراین گزینه پیش‌فرض <samp>هرگز</samp> می باشد.',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'سطوح دسترسی کاربر برای این انجمن <samp>نه</samp> می باشد و داده مجموع نه می باشد،بنابراین گزینه پیش‌فرض <samp>هرگز</samp> می باشد.',
