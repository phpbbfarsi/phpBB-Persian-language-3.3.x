...
$lang = array_merge($lang, array(
	...
	'ACL_SET_EXPLAIN'			=> 'سطوح دسترسی بر پایه یک سیستم کوچک <strong>بلی</strong>/<strong>خیر</strong> هستند. تعیین یک گزینه با وضعیت <strong>هیچگاه</strong> برای یک کاربر یا یک گروه ، مقادیر تعیین شده دیگر را مقدم می کند. در صورتی که نمی خواهید یک مقدار را برای گزینه ای تعیین کنید ( برای کاربر یا گروه ) <strong>خیر</strong> را مستقر کنید، اگر مقادیر  برای این گزینه قرار است در جای دیگری تقدم یابد <strong>هیچگاه</strong> فروض استتمام اشیاء علامت گذاری شده (با چک باکس جلوی آنها) مجموعه مجوزی را که شما تعریف کرده اید کپی می کنند. لطفاً توجه داشته باشید که تنظیم مجوزهای اداری برای حساب‌های مؤسس هیچ تأثیری ندارد زیرا مجوزهای سرپرست همیشه برای مؤسسان روی <strong>بله</strong> تنظیم می‌شود.',
	'ACL_SETTING'			=> 'تنظیمات',
