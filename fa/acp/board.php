...
$lang = array_merge($lang, array(
	...
	'FULL_FOLDER_ACTION_EXPLAIN'=> 'عملکرد پیشفرضی که اگر پوشه پیام خصوصی پر شود، آن عمل روی خواهد داد. اگر در همه ی آنها اعمال شود مناسب نخواهد بود. تنها استثنا در پوشه "پیام های ارسال شده" وجود دارد که در صورت پر شدن این پوشه، همیشه پیام های قدیمی تر حذف خواهند شد.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_AUTH_METHOD_EXPLAIN'		=> 'فقط هنگامی استفاده کنید که نام کاربری و کلمه عبور تأیید شده باشد، اگر مطمئن نیستید که از کدام گزینه استفاده کنید، با سرویس دهنده خود تماس بگیرید.',
