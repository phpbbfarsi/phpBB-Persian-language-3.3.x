...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'                => 'می توانید مشخص کنید که آیا کاربران می توانند بعد از ثبت نام مستقیما به تالار دسترسی داشته باشند و یا باید ابتدا اکانت خود را فعال کنند. همچنین می توانید به طور کلی ثبت نام های جدید را غیرفعال کنید. <em>“Board-wide ایمیل” بایستی فعال باشد تا بتوان فعال سازی اکانت ها صورت پذیرد.</em>',
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'در این قسمت شما میتوانید صفحه تماس با ما را فعال یا غیرفعال کنید که همراه با متنی برای آن خواهد بود.',
...
$lang = array_merge($lang, array(
	...
	'USE_SYSTEM_CRON_EXPLAIN'		=> 'هنگامیکه این گزینه غیرفعال باشد phpBB به صورت وظایف دوره ای را انجام میدهد. و هنگامیکه این گزینه فعال باشد phpBB هیچ وظیفه دوره را به تنهایی انجام نخواهد داد; و شما میتوانید آنرا تنظیم کنید که وظیفه آن در فایل <code>bin/phpbbcli.php cron:run</code> خواهد بود. شما میتوانید بر حسب دقیقه مثلا 5 دقیقه سیستم را به دلخواه تنظیم کنید.',
));
