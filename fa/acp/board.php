...
$lang = array_merge($lang, array(
	...
	'ALLOW_AVATARS_EXPLAIN'			=> 'پذیرفتن استفاده عمومی از آواتار؛<br>اگر آواتار ها را به کلی و یا برای حالت خاص غیر فعال کنید، دیگر آواتار ها در تالار نمایش داده نخواهند شد ولی کاربران خواهند توانست که آواتار های خودشان را از کنترل پنل کاربر بارگیری کنند.',
