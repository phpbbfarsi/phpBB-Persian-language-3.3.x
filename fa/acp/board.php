...
// Avatar Settings
$lang = array_merge($lang, array(
	'ACP_AVATAR_SETTINGS_EXPLAIN'	=> 'نمایه ها یا ( آواتار ها )معمولا تصاویر کوچکی هستند که کاربران می توانند برای خود انتخاب کنند اندازه آن‌ها به قالب مورد استفاده در تالار بستگی دارد و معمولا زیر نام کاربری نمایش داده می شوند. در این بخش می توانید معیار های انتخاب نمایه را برای کاربران مشخص کنید. لطفا توجه داشته باشید که دایرکتوری های مشخص شده در قسمت پایین باید ایجاد شده و سطح دسترسی نوشتن بر روی آن‌ها اعمال شود. همچنین توجه داشته باشید که این تنظیمات فقط برای نمایه ها هستند و سایر تصاویر ربطی به این بخش ندارد.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'این گزینه باعث میشود کاربران بتوانند گذرواژه خود را در صورت فراموشی بازنشانی کنند. چنانچه از سرویس های خارجی برای ورود کاربران استفاده میکنید این گزینه را غیر فعال کنید.',
