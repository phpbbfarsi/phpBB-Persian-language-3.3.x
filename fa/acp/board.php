...
$lang = array_merge($lang, array(
	...
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'پذیرفتن ورود تاریخ تولد و نمایش آن در نمایه. لطفاً توجه داشته باشید که تنظیمات بلوک تاریخ تولد که در صفحه اول نمایش داده می شود، متفاوت است.',
...
// Avatar Settings
$lang = array_merge($lang, array(
	'ACP_AVATAR_SETTINGS_EXPLAIN'	=> 'آواتار ها معمولا تصاویر کوچکی هستند که کاربران می توانند برای خود انتخاب کنند اندازه آن‌ها به قالب مورد استفاده در تالار بستگی دارد و معمولا زیر نام کاربری نمایش داده می شوند. در این بخش می‌توانید معیار های انتخاب آواتار را برای کاربران مشخص کنید. لطفاً توجه داشته باشید که دایرکتوری های مشخص شده در قسمت پایین باید ایجاد شده و سطح دسترسی نوشتن بر روی آن‌ها اعمال شود. همچنین توجه داشته باشید که این تنظیمات فقط برای آواتار ها هستند و سایر تصاویر ربطی به این بخش ندارد.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_WARNING'		=> 'لطفاً توجه داشته باشید روش فعال سازی انتخابی شما نیاز به فعال سازی ارسال ایمیل دارد ، در غیر این صورت ثبت نام کاربران غیرفعال می شود. توصیه میکنیم دو روش برای ثبت نام انتخاب کنید و یا ایمیل ها را فعال کنید.', 
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'احراز هویت HTTP را فعال می‌کند و به کاربران امکان می‌دهد با افزودن پارامتر <samp>auth=http</samp> به آدرس خوراک، به محتوایی که از مهمانان پنهان است دسترسی پیدا کنند. لطفاً توجه داشته باشید که برخی تنظیمات PHP ممکن است نیاز به تغییرات اضافی در فایل .htaccess داشته باشند؛ برای راهنمایی به آن فایل مراجعه کنید. احراز هویت HTTP تنها از طریق اتصالات رمزنگاری شده (https) پشتیبانی می‌شود.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'در این صفحه کاربران میتوانند با مدیریت کل سایت از طریق ایمیل ارتباط برقرار کنند لطفاً توجه داشته باشید که باید تنظیمات ایمیل فعال باشد. تنظیمات مربوطه در بخش اصلی و تنظیمات ایمیل وجود دارد.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_PASSWORD_EXPLAIN'			=> 'برای اتصال بی نام این فیلد را خالی بگذارید. در غیر این صورت برای نام کاربری ذکر شده در بالا گذرواژه‌ای تعریف کنید. تا سرور های دایرکتوری فعال شود.<br><em><strong>هشدار :</strong> این گذرواژه در قالب متن ساده در پایگاه داده ذخیره خواهد شد. و برای همین برای هرکسی که به پایگاه داده دسترسی پیدا کند و یا به این صفحه مراجعه کند،قابل بازدید خواهد بود.</em>',
	...
	'LDAP_SERVER_EXPLAIN'			=> 'اگر از سرور LDAP استفاده می کنید،نام هاست و یا آدرس IPرا وارد کنید. به عنوان جایگزین می‌توانید لینکی مانند ldap://hostname:port/ تعیین کنید.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'اگر این گزینه غیرفعال باشد،هیچ ایمیلی از تالار ارسال نخواهد شد. <em>لطفاً توجه داشته باشید که تنظیمات فعال سازی حساب کاربران و مدیران نیازمند آن است تا این گزینه فعال باشد. اگر اخیراً از فعال سازی "کاربران" و یا "مدیران" استفاده می کنید، غیرفعال کردن این گزینه، باعث غیرفعال شدن ثبت نام می شود.</em>',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'لطفاً از پروتوکل (<samp>ssl://</samp> or <samp>tls://</samp>)  استفاده نکنید، مگر سرور به شما اجازه چنین کاری بدهد',
...
$lang = array_merge($lang, array(
	...
	'JAB_GTALK_NOTE'				=> 'لطفاً توجه کنید که GTalk ممکن است کار  نکند به دلیل عملکرد<samp>dns_get_record</samp>که ممکن است یافت نشود. اسن عملکرد در PHP4 وجود ندارد و با پلتفرم های ویندوز سازگار نیست.و همچنین با سیستم ها BSD مانند مک او اس نیز سازگار نیست. ',
