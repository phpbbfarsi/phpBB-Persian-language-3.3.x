...
$lang = array_merge($lang, array(
	...
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'نمایش آخرین پست های ارسال شده در لیست انجمن ها در صفحه اصلی به عنوان لینک. عنوان هایی که در انجمن های دارای گذرواژه و یا کاربردسترسی خواندن به آنها را نداشته باشد نمایش داده نمیشود.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_NO_CENSORS_EXPLAIN'	=> 'کاربران می تواند سانسور خودکار کلمات را در انجمن ها و پیام های خصوصی غیر فعال کنند.',
	'ALLOW_PM_ATTACHMENTS'		=> 'پذیرفتن پیوست در پیام های خصوصی',
	'ALLOW_PM_REPORT'			=> 'پذیرفتن گزارش پیام های خصوصی از جانب کاربران',
	'ALLOW_PM_REPORT_EXPLAIN'	=> 'اگر این گزینه فعال باشد کاربران می توانند پیام های خصوصی دریافت شده از جانب انها را به مدیر گزارش دهند،پغام های گزارش شده در کنترل پنل مدیریت برای مدیران قابل نمایش خواهند بود.',
...
$lang = array_merge($lang, array(
	...
	'FULL_FOLDER_ACTION_EXPLAIN'=> 'عملکرد پیش‌فرضی که اگر پوشه پیام خصوصی پر شود، آن عمل روی خواهد داد. اگر در همه ی آنها اعمال شود مناسب نخواهد بود. تنها استثنا در پوشه "پیام های ارسال شده" وجود دارد که در صورت پر شدن این پوشه، همیشه پیام های قدیمی تر حذف خواهند شد.',
...
$lang = array_merge($lang, array(
	...
	'CHAR_LIMIT'					=> 'حداکثر تعداد کاراکتر در پست ها/پیام ها',
	'CHAR_LIMIT_EXPLAIN'			=> 'حداکثر تعداد کاراکتر مورد قبول در پست ها و پیام های خصوصی. برای غیرفعال کردن این ویژگی 0 را وارد کنید.',
	...
	'MIN_CHAR_LIMIT'				=> 'حداقل تعداد کاراکتر مورد نیاز در هر پست/پیام',
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'حداقل تعداد کاراکتر مورد نیاز در  هر پست و یا پیام خصوصی. حداقل داده برای این تابع 1 می باشد.',
	'POSTING'						=> 'ارسال',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'اگر بله انتخاب شود و محدودیت ارسال پست اعمال شود، کاربرانی که به تازگی عضو شده اند علاوه بر این که در گروه <em>کاربران تازه عضو شده</em> قرار می گیرند،بلکه این گروه،گروه پیش‌فرض آنها نیز خواهد بود. اگر می خواهید برای یک گروه پیش‌فرض رتبه/و یا نمایه تعریف کنید، این گزینه میتواند سودمند باشد.',
...
//	'ACC_USER_ADMIN'			=> 'کاربر + مدیر',
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> 'حداقل تعداد کاراکتر برای گذرواژه. توجه کنید که این مقدار محدودیت ندارد',
	'REG_LIMIT'					=> 'محدودیت اقدام به ثبت نام',
	'REG_LIMIT_EXPLAIN'			=> 'حداکثر تعدادی که کاربران می توانند اقدام به وارد کردن کد تأیید کنند. بعد از این تعداد،بخش ثبت نام در یک بازه زمانی برای آنها غیرفعال خواهد شد.',
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_GD_FONTS_EXPLAIN'				=> 'این گزینه نحوه نمایش کاراکتر ها در تصویر را مشخص می کند. می توانید از اشکال پیش‌فرض استفاده کنید و یا این اشکال را تغییر دهید.اضافه کردن حروف کوچک هم ممکن است.',
...
$lang = array_merge($lang, array(
	...
	'RECOMPILE_STYLES_EXPLAIN'		=> 'به‌روز رسانی های اجزای قالب را در سیتم های فایل کنترل کرده و آنها را تألیف می کند.',
	'YES_ACCURATE_PM_BUTTON'			=> 'دسترسی نمایش دکمه پیام خصوصی در صفحه موضوعات',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> 'با فعال سازی این گزینه ،در قسمت پروفایل کاربر در پست ها ، دکمه ارسال پیام خصوصی به نمایش در خواهد آمد.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_USER_FILTER_EXPLAIN'		=> 'برای جست‌وجوی اشیاء مورد نظر میتوانید از فیلتر های بیشتر جست‌وجو استفاده کنید. برای مثال در نتیجه جست‌وجوی <samp>objectClass=posixGroup</samp> ، <samp>(&amp;(uid=$username)(objectClass=posixGroup))</samp> ظاهر خواهد شد.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'این گزینه باعث میشود کاربران بتوانند گذرواژه خود را در صورت فراموشی بازیابی کنند. چنانچه از سرویس های خارجی برای ورود کاربران استفاده میکنید این گزینه را غیر فعال کنید.',
	...
	'EMAIL_CHECK_MX_EXPLAIN'		=> 'اگر فعال شود ایمیل های وارد شده در حین ثبت نام و یا پروفایل،برای یافتن 	MX record جست‌وجو می شوند.',
