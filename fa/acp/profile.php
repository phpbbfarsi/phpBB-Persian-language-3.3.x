...
$lang = array_merge($lang, array(
	...
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'فیلد تماس ، جهت ارتباط با کاربر می‌باشد که در لیست تماس ها قرار میگیرد. مثل فیس بوک،گوگل پلاس و... شما میتوانید از <samp>%s</samp> به عنوان یک متغیر مکانی استفاده کنید که جایگزین مقدار وارد شده توسط کاربر می باشد.',
	...
	'STEP_2_EXPLAIN_EDIT'			=> 'در این بخش میتوانید گزینه های عمومی را تنظیم کنید.<br /><strong>توجه داشته باشید که این تغییرات در فیلد های نمایهی که توسط کاربران ایجاد شده اند اعمال نخواهد شد.</strong>',
