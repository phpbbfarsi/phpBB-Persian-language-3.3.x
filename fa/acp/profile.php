...
$lang = array_merge($lang, array(
	...
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'فیلد تماس ، جهت ارتباط با کاربر می‌باشد که در لیست تماس ها قرار میگیرد. مثل فیس بوک،گوگل پلاس و... شما می‌توانید از <samp>%s</samp> به عنوان یک متغیر مکانی استفاده کنید که جایگزین مقدار وارد شده توسط کاربر می باشد.',
