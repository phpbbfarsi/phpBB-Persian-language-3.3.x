...
$lang = array_merge($lang, array(
	...
	'STEP_3_EXPLAIN_CREATE'			=> 'اگر بیش از یک زیان در تالارتان نصب شده باشد. باید سایر موارد زبان را نیز تکمیل کنید. فیلد پروفایل با زبان پیش‌فرض سازگار خواهد بود، می توانید سایر زبان ها را هم تکمیل کنید.',
	'STEP_3_EXPLAIN_EDIT'			=> 'اگر بیش از یک زبان در تالارتان نصب باشد،می توانید تغییرات را در سایر زبان ها هم اعمال کنید. فیلد های پروفایل با زبان پیش‌فرض سازگاری دارند.',
