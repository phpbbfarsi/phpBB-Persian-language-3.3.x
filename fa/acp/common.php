...
$lang = array_merge($lang, array(
	...
	'RESYNC_POSTCOUNTS_CONFIRM'		=> 'آیا از همگام سازی مجدد تعداد پست ها مطمئن هستید؟',
	'RESYNC_POSTCOUNTS_SUCCESS'		=> 'همگام سازی مجدد پست ها انجام شد',
	'RESYNC_POST_MARKING'			=> 'همگام سازی مجدد موضوعات علامت گذاری شده',
	'RESYNC_POST_MARKING_CONFIRM'	=> 'آیا از همگام سازی مجدد موضوعات علامت گذاری شده مطمئن هستید؟',
	...
	'RESYNC_STATS_CONFIRM'			=> 'آیا از همگام سازی مجدد آمار مطمئن هستید؟',
