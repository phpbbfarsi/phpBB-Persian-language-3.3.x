...
$lang = array_merge($lang, array(
	...
	'RESYNC_POSTCOUNTS_CONFIRM'		=> 'آیا از همگام سازی مجدد تعداد پست ها اطمینان دارید؟',
	'RESYNC_POSTCOUNTS_SUCCESS'		=> 'همگام سازی مجدد پست ها انجام شد',
	'RESYNC_POST_MARKING'			=> 'همگام سازی مجدد مباحث علامت گذاری شده',
	'RESYNC_POST_MARKING_CONFIRM'	=> 'آیا از همگام سازی مجدد مباحث علامت گذاری شده اطمینان دارید؟',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'همگام سازی مجدد مباحث علامت گذاری شده انجام شد',
	'RESYNC_STATS'					=> 'همگام سازی مجدد آمار',
	'RESYNC_STATS_CONFIRM'			=> 'آیا از همگام سازی مجدد آمار اطمینان دارید؟',
	'RESYNC_STATS_EXPLAIN'			=> 'محاسبه مجدد تعداد پست ها ، مباحث ، اعضا و فایل ها.',
