...
$lang = array_merge($lang, array(
	...
	'EXTENSION_NOT_AVAILABLE'	=> 'افزونه انتخابی در انجمن شما قابل دسترس نیست. لطفاً نسخه phpBB و php انجمن خود را بررسی کنید. (مشاهده صفحه جزئیات).',
	'EXTENSION_DIR_INVALID'		=> 'افزونه انتخابی در مسیر نامعتبری بارگذاری شده است و قابل فعال سازی نیست.',
	'EXTENSION_NOT_ENABLEABLE'	=> 'افزونه انتخابی قابل فعال سازی نمی‌باشد, لطفاً موارد لازم را بررسی نمایید.',
	'EXTENSION_NOT_INSTALLED'	=> 'افزونه %s دردسترس نیست. لطفاً بررسی کنید که به درستی نصب شده است.',
	...
	'EXTENSION_DELETE_DATA_IN_PROGRESS'	=> 'داده‌های افزونه در حال حذف می باشند. لطفاً تا کامل شدن مراحل حذف ،این صفحه را ترک یا رفرش نکنید.',
	'EXTENSION_DISABLE_IN_PROGRESS'	=> 'افزونه در حال غیرفعال شدن است. تا کامل شدن مراحل ، لطفاً این صفحه را ترک یا رفرش نکنید.',
	'EXTENSION_ENABLE_IN_PROGRESS'	=> 'افزونه در حال فعال شدن است. تا کامل شدن مراحل لطفاً این صفحه را ترک یا رفرش نکنید.',
