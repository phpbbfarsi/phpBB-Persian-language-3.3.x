...
$lang = array_merge($lang, array(
	'AUTO_PRUNE_DAYS'			=> 'هرس کردن خودکار پست‌های کهنه شده',
	...
	'AUTO_PRUNE_SHADOW_FREQ'	=> 'دوره هرس سایه موضوعات',
	'AUTO_PRUNE_SHADOW_DAYS'	=> 'مدت بین روزهای رویداد هرس سایه موضوعات',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'تعداد روزهای تعیین شده ای که بعد از آن سایه موضوعات حذف خواهد شد.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'تعداد دفعات هرس خودکار سایه موضوعات در روز',

	'CONTINUE'						=> 'ادامه',
	'COPY_PERMISSIONS'				=> 'کپی کردن سطح دسترسی از',
	...
	'ENABLE_INDEXING'				=> 'فعال سازی شاخص بندی جست‌وجو',
	'ENABLE_INDEXING_EXPLAIN'		=> 'اگر بله انتخاب شود،پست‌های ایجاد شده در شاخص های جست‌وجو قرار خواهند گرفت.',
	'ENABLE_POST_REVIEW'			=> 'فعال سازی پیش‌نمایش پست‌ها',
	'ENABLE_POST_REVIEW_EXPLAIN'	=> 'اگر بله انتخاب شود،کاربران در حین ارسال پست خواهند توانست پیش‌نمایش مطلب ارسالی را ببینند،در انجمن‌های چت این گزینه باید غیرفعال باشد.',
	...
	'FORUM_ADMIN_EXPLAIN'				=> ' در phpBB همه چیز بر اساس انجمن‌ها است، گروه‌ها نیز نوع ویژه ای از انجمن‌ها هستند، همه چیز بر اساس انجمن‌ها ساخته می شود به طوری که می‌توانید به تعداد نامحدودی زیرانجمن ایجاد کرده و مشخص کنید که در کدام یک از آن‌ها امکان ارسال پست وجود داشته باشد (برای مثال تعیین این که مانند گروه‌های قدیمی عمل کند و یا نه). در این بخش می‌توانید علاوه بر برخی از تنظیمات انجمن‌ها را اضافه، ویرایش، حذف و یا قفل کنید اگر پست‌ها و موضوعات انطباقات خود را از دست بدهند، می‌توانید مجددا آن‌ها را همگام سازی کنید. <strong>برای نمایش انجمن‌های جدید باید سطوح دسترسی برای آن‌ها تعیین کنید و یا از سایر انجمن‌ها سطوح دسترسی را کپی کنید.</strong>',
	...
	'FORUM_DESC_TOO_LONG'				=> 'توضیخات انجمن بسیار طولانی است،توضیحات باید کمتر از 4000 نویسه باشند.',
	...
	'FORUM_EDIT_EXPLAIN'				=> 'با استفاده از فرم زیر می‌توانید انجمنتان را مدیریت کنید. لطفاً توجه داشته باشید که تنظیمات مدیریت و شمارنده پست‌ها برای کاربران و گروه‌های کاربری در سطوح دسترسی اعمال می شود. ',
	...
	'FORUM_NAME_EMOJI'					=> 'نام انجمن وارد شده نامعتبر است<br> حاوی نویسه‌های غیر مجاز<br>%s',
	'FORUM_PARENT'						=> 'انجمن ریشه',
	'FORUM_PASSWORD'					=> 'گذرواژه انجمن',
	'FORUM_PASSWORD_CONFIRM'			=> 'تأیید گذرواژه انجمن',
	'FORUM_PASSWORD_CONFIRM_EXPLAIN'	=> 'اعمال این تنظیمات فقط هنگامی لازم است که گذرواژه‌ای وارد شود.',
	'FORUM_PASSWORD_EXPLAIN'			=> 'با استفاده از سطوح دسترسی سیستم، گذرواژه‌ای را برای انجمن تعیین می کند.',
	'FORUM_PASSWORD_UNSET'				=> 'حذف گذرواژه انجمن',
	'FORUM_PASSWORD_UNSET_EXPLAIN'		=> 'اگر می خواهید که گذرواژه انجمن حذف شود، بر روی این گزینه تیک بزنید.',
	'FORUM_PASSWORD_OLD'				=> 'گذرواژه انجمن از روش قدیمی هش استفاده می کند و باید تغییر داده شود.',
	'FORUM_PASSWORD_MISMATCH'			=> 'دو گذرواژه وارد شده یکسان نمی باشند',
	'FORUM_PRUNE_SETTINGS'				=> 'تنظیمات هرس انجمن',
	'FORUM_PRUNE_SHADOW'				=> 'فعال سازی هرس خودکار سایه موضوعات',
	'FORUM_PRUNE_SHADOW_EXPLAIN'		=> 'فعال سازی هرس خودکار سایه موضوعات به معنای دوره و زمان هرس آن خواهد بود.',
	'FORUM_RESYNCED'					=> 'انجمن “%s” با موفقیت همگام سازی مجدد شد',
	'FORUM_RULES_EXPLAIN'				=> 'قوانین انجمن در هر صفحه مشخص شده از انجمن نمایش داده خواهد شد.',
	'FORUM_RULES_LINK'					=> 'لینک به قوانین انجمن',
	'FORUM_RULES_LINK_EXPLAIN'			=> 'می‌توانید پست و یا لینکی را در این تنظیم وارد کنید، انتخاب شما جایگزین متن پیش‌فرض قوانین تالار خواهد شد. ',
	'FORUM_RULES_PREVIEW'				=> 'آزمایش قوانین انجمن',
	'FORUM_RULES_TOO_LONG'				=> 'قوانین انجمن باید کمتر از 4000 نویسه باشد.',
	'FORUM_SETTINGS'					=> 'تنظیمات انجمن',
	'FORUM_STATUS'						=> 'حالت انجمن',
	'FORUM_STYLE'						=> 'قالب انجمن',
	'FORUM_TOPICS_PAGE'					=> 'موضوعات در هر صفحه',
	'FORUM_TOPICS_PAGE_EXPLAIN'			=> 'اگر عددی به غیر از 0 را وارد کنید، این تعداد جایگزین تعداد پپیش‌فرض خواهد شد.',
	'FORUM_TYPE'						=> 'نوع انجمن',
	'FORUM_UPDATED'						=> 'اطلاعات انجمن با موفقیت به‌روز رسانی شد.',

	'FORUM_WITH_SUBFORUMS_NOT_TO_LINK'		=> 'در حال تبدیل انجمنی زیرانجمن دار به لینک هستید،قبل از پردازش این فرآیند لطفاً زیرانجمن‌ها را به انجمنی دیگر منتقل دهید زیرا پس از تبدیل این انجمن به لینک،زیرانجمن‌های آن در دسترس نخواهد بود.',
	...
	'LIST_INDEX'				=> 'نمایش زیر انجمنها در فهرست',
	'LIST_INDEX_EXPLAIN'		=> 'با فعال کردن این گزینه, انجمن مورد نظر در هر کجای انجمنها باشد در نخستین صفحه قابل نمایش می‌باشد. برای آنکه تمامی زیر انجمنها فقط در انجمن والد خود نمایش داده شوند گزینه "نمایش فهرست زیر انجمنها در انجمن والد" را انتخاب نمائید.',
	'LIST_SUBFORUMS'			=> 'نمایش فهرست زیر انجمنها در انجمن والد',
	'LIST_SUBFORUMS_EXPLAIN'	=> 'در صورت فعال نمودن این گزینه تمامی زیر انجمنهای هر والد فقط در فهرست زیر انجمن خود والد نمایش داده میشوند. در صورتی که میخواهید انجمنها در صفحه نخست هم نمایش داده شوند این گزینه "نمایش زیر انجمنها در فهرست" را فعال نمائید.',
	'LOCKED'					=> 'قفل شده',

	'MOVE_POSTS_NO_POSTABLE_FORUM'	=> 'در انجمنی که برای انتقال پست‌ها به آن انتخاب کرده اید،ارسال پست مقدور نیست، لطفاً انجمنی را انتخاب کنید که ارسال پست در آن مقدر باشد.',
	...
	'SYNC_IN_PROGRESS'			=> 'همزمان سازی انجمن',
	'SYNC_IN_PROGRESS_EXPLAIN'	=> ' همگام سازی کنونی انجمن‌ها %1$d/%2$d.',
