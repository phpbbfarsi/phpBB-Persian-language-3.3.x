...
$lang = array_merge($lang, array(
	...
	'LIST_INDEX_EXPLAIN'		=> 'با فعال کردن این گزینه, انجمن مورد نظر در هر کجای انجمنها باشد در نخستین صفحه قابل نمایش میباشد. برای آنکه تمامی زیر انجمنها فقط در انجمن والد خود نمایش داده شوند گزینه "نمایش فهرست زیر انجمنها در انجمن والد" را انتخاب نمائید.',
