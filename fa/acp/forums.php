...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN_EXPLAIN'				=> ' در phpBB همه چیز براساس انجمن ها است، گروه ها نیز نوع ویژه ای از انجمن ها هستند، همه چیز براساس انجمن ها ساخته می شود به طوری که می توانید به تعداد نامحدودی زیرانجمن ایجاد کرده و مشخص کنید که در کدام یک از آن‌ها امکان ارسال پست وجود داشته باشد (برای مثال تایین این که مانند گروه های قدیمی عمل کند و یا نه). در این بخش می توانید علاوه بر برخی از تنظیمات انجمن ها را اضافه،ویرایش،حذف و یا قفل کنید اگر پست ها و موضوعات انطباقات خود را از دست بدهند، می توانید مجددا آن‌ها را منطبق (resync) کنید. <strong>برای نمایش انجمن های جدید باید سطوح دسترسی برای آن‌ها تایین کنید و یا از سایر انجمن ها سطوح دسترسی را کپی کنید.</strong>',
