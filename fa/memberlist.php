...
$lang = array_merge($lang, array(
	...
	'FLOOD_EMAIL_LIMIT'		=> 'فعلا نمی‌توانید ایمیل دیگری بفرستید، لطفاً بعدا تلاش کنید.',
	...
	'IM_JABBER'				=> 'لطفاً توجه داشته باشید که ممکن است کاربران عدم دریافت پیام‌های سریع ناخواسته را انتخاب کرده باشند.',
	'IM_JABBER_SUBJECT'		=> 'این یک پیام خودکار هست، لطفاً جواب ندهید! ارسال شده توسط %1$s در %2$s.',
	'IM_MESSAGE'			=> 'پیام شما',
	'IM_NAME'				=> 'نام شما',
