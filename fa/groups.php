...
$lang = array_merge($lang, array(
	...
	'GROUP_IS_OPEN'						=> 'این یک گروه باز است، اعضا میتوانند درخواست عضویت دهند.',
	'GROUP_IS_SPECIAL'					=> 'این یک گروه ویژه است، گروههای ویژه توسط مدیر کل سایت، مدیریت میشوند.',
	...
	'GROUP_JOIN_PENDING_CONFIRM'		=> 'آیا مطمئنید که میخواهید عضو این گروه شوید؟',
