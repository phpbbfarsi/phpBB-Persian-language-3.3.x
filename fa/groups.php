...
$lang = array_merge($lang, array(
	...
	'GROUP_IS_OPEN'						=> 'این یک گروه باز است، اعضا میتوانند درخواست عضویت را تایید کنند.',
	...
	'GROUP_JOIN_PENDING_CONFIRM'		=> 'آیا از درخواست عضویت در گروه انتخاب شده اطمینان دارید؟',
	...
	'GROUP_RESIGN_MEMBERSHIP_CONFIRM'	=> 'آیا از استعفا دادن از گروه انتخاب شده اطمینان دارید؟',
	'GROUP_RESIGN_PENDING'				=> 'استعفا از عضویت گروه در انتظار',
	'GROUP_RESIGN_PENDING_CONFIRM'		=> 'آیا از استعفا دادن از گروه در انتظار انتخاب شده اطمینان دارید؟',
	...
	'NOT_MEMBER_OF_GROUP'			=> 'درخواست شما برای انجام عملیات بی فایده است، زیرا شما عضو گروه انتخاب شد نیستید یا عضویت شما هنوز تایید نشده است.',
