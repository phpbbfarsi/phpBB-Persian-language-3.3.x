...
$lang = array_merge($lang, array(
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'در این بخش، برای جلوگیری از ورود های مخرب به اکانتتان، اگر بیش از مقدار تایین شده به صورت نادرست کلمه عبور و نام کاربریتان را وارد کنید، از شما خواهد خواست که که کد تایید را وارد کنید. اگر نمیتوانید کد را ببینید و یا بخوانید لطفا با %sمدیر کل تالار%s تماس بگیرید.', // unused
	...
	'NOT_AUTHORISED'			=> 'شما برای دسترسی به این بخش تایید اعتبار نشدید.',
