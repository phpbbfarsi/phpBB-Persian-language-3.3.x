...
$lang = array_merge($lang, array(
	...
	'LOGIN_ERROR_PASSWORD'				=> 'گذرواژه وارد شده اشتباه میباشد، لطفا گذرواژه خود را بررسی کنید و مجددا تلاش کنید. اگر نتوانستید با %sمدیر کل تالار%s تماس بگیرید.',
	...
	'LOGIN_ERROR_USERNAME'				=> 'نام کاربری نادرستی را وارد کرده اید، لطفا نام کاربری خود را بررسی کنید و مجددا تلاش کنید. اگر بازهم مشکلی داشتید با %sمدیر کل تالار%s تماس بگیرید.',
	'LOGIN_FORUM'						=> 'برای مشاهده یا ارسال پست در این انجمن باید گذرواژه آن را وارد کنید.',
	'LOGIN_INFO'						=> 'برای ورود باید ثبت نام کنید، ثبت نام در تالار فقط چند لحظه طول میکشد ولی سطح دسترسیتان را بالا میبرد. مدیر تالار میتواند به کاربران اختیارات دیگری نیز دهد و سطح دسترسی آن‌ها را بالا ببرد، قبل از ثبت نام لطفا قوانین تالار را بخوانید و از آشنایی با آن‌ها مطمئن شوید تا در آینده مشکلی پیش نیاید.',
	...
	'RULES_VOTE_CANNOT'			=> 'در این انجمن <strong>نمیتوانید</strong> به نظرسنجی ها رای بدهید',
	...
	'SQL_ERROR_OCCURRED'		=> 'خطای SQL در هنگام بارگزاری این صفحه بوجود آمده است. اگر این مشکل همچنان ادامه داشت، لطفا با %sمدیر کل تالار%s تماس بگیرید.',
	...
	'TOPIC_LOCKED'		=> 'این موضوع قفل شده است، نمیتوانید پستی را ویرایش یا پاسخی را ارسال کنید.',
