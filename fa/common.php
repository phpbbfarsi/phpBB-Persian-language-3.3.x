...
$lang = array_merge($lang, array(
	...
	'AVATAR_NO_SIZE'				=> 'طول و عرض آواتار لینک داده شده مشخص نیست، لطفا این اطلاعات را دستی وارد کنید.',
	...
	'BOARD_DISABLED'		=> 'درحال حاضر این انجمن غیر فعال است.',
	'BOARD_UNAVAILABLE'		=> 'متاسفیم ولی این انجمن موقتا در دسترس نیست، لطفا دقایقی دیگر مراجعه فرمائید.',
	...
	'CONFIRM_CODE_WRONG'	=> 'کد تأیید وارد شده نادرست میباشد.',
	'CONFIRM_OPERATION'		=> 'آیا از انجام این کار مطمئن هستید؟',
	'CONFIRM_AVATAR_DELETE' => 'آیا از حرف این آواتار مطمئن هستید؟',
	...
	'INVALID_PLURAL_RULE'		=> 'قانون صیغه جمع (plural) انتخاب شده نامعتبر است. مقادیر معتبر بین 0 تا 15 میباشد',
	'IP'						=> 'آی پی',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'در این بخش، برای جلوگیری از ورود های مخرب به اکانتتان، اگر بیش از مقدار تایین شده به صورت نادرست کلمه عبور و نام کاربریتان را وارد کنید، از شما خواهد خواست که که کد تأیید را وارد کنید. اگر نمیتوانید کد را ببینید و یا بخوانید لطفا با %sمدیر کل تالار%s تماس بگیرید.', // unused
	'LOGIN_ERROR_ATTEMPTS'				=> 'بیش از حد مجاز اقدام به ورود به اکانتتان کرده اید، حال باید علاوه بر وارد کردن نام کاربری و کلمه عبور، کد تأیید را نیز وارد کنید.',
	...
	'LOGIN_ERROR_PASSWORD'				=> 'کلمه عبور وارد شده اشتباه میباشد، لطفا کلمه عبور خود را برسی کنید و مجددا تلاش کنید. اگر نتوانستید با %sمدیر کل تالار%s تماس بگیرید.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'در حین به‌روز رسانی نرم افزار داخلی این تالار، امکان بازگردانی کلمه عبور شما وجود ندارد. لطفا %sکلمه عبور جدید%s را درخواست کنید. اگر باز هم مشکلی داشتید، لطفا با %sمدیر کل تالار%s تماس بگیرید.',
	'LOGIN_ERROR_USERNAME'				=> 'نام کاربری نادرستی را وارد کرده اید، لطفا نام کاربری خود را برسی کنید و مجددا تلاش کنید. اگر بازهم مشکلی داشتید با %sمدیر کل تالار%s تماس بگیرید.',
	'LOGIN_FORUM'						=> 'برای مشاهده یا ارسال پست در این انجمن باید کلمه عبور آن را وارد کنید.',
	'LOGIN_INFO'						=> 'برای ورود باید ثبت نام کنید، ثبت نام در تالار فقط چند لحظه طول میکشد ولی سطح دسترسیتان را بالا میبرد. مدیر تالار میتواند به کاربران اختیارات دیگری نیز دهد و سطح دسترسی آنها را بالا ببرد، قبل از ثبت نام لطفا قوانین تالار را بخوانید و از آشنایی با آنها مطمئن شوید تا در آینده مشکلی پیش نیاید.',
	...
	'NOT_AUTHORISED'			=> 'شما برای دسترسی به این بخش تأیید اعتبار نشدید.',
	...
	'NOTIFICATION_POST_APPROVED'		=> '<strong>تأیید پست</strong>:',
	'NOTIFICATION_POST_DISAPPROVED'		=> '<strong>تأیید نشدن پست</strong>:',
	'NOTIFICATION_POST_IN_QUEUE'		=> '<strong>تأیید پست</strong> توسط %1$s:',
	'NOTIFICATION_QUOTE'				=> array(
		1	=> '<strong>نقل قول</strong> توسط %1$s در:',
	),
	'NOTIFICATION_REFERENCE'			=> '"%1$s"',
	'NOTIFICATION_REASON'				=> '<em>دلیل:</em> %1$s.',
	'NOTIFICATION_REPORT_PM'			=> '<strong>گزارش پیام خصوصی</strong> توسط %1$s:',
	'NOTIFICATION_REPORT_PM_CLOSED'		=> '<strong>گزارش پیام بسته شده </strong> توسط %1$s:',
	...
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>تأیید موضوع</strong>:',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> '<strong>تأیید نشدن موضوع</strong>:',
	'NOTIFICATION_TOPIC_IN_QUEUE'		=> '<strong>تأیید موضوع</strong> توسط %1$s:',
	...
	'SQL_ERROR_OCCURRED'		=> 'خطای SQL در هنگام بارگزاری این صفحه بوجود آمده است. اگر این مشکل همچنان ادامه داشت، لطفا با %sمدیریت سایت%s تماس بگیرید.',
	...
	'TOO_LONG_PASSWORD_CONFIRM'		=> 'تأیید کلمه عبور وارد شده بسیار طولانی است.',
	...
	'TOO_SHORT_PASSWORD_CONFIRM'	=> 'تأیید کلمه عبور وارد شده بسیار کوتاه است.',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'متاسفیم، اجازه دسترسی به این ویژگی را ندارید، برای بالا بردن سطح دسترسیتان لطفا بیشتر در تالار فعالیت کنید تا بتوانید از این ویژگی استفاده کنید.',
