...
$lang = array_merge($lang, array(
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'در این بخش، برای جلوگیری از ورودی های مخرب به اکانتتان، اگر بیش از مقدار تایین شده به صورت نادرست کلمه عبور و نام کاربریتان را وارد کنید، از شما خواهد خواست که که کد تایید را وارد کنید. اگر نمیتوانید کد را ببینید و یا بخوانید لطفا با %sمدیر کل تالار%s تماس بگیرید.', // unused
	...
	'LOGIN_ERROR_OAUTH_SERVICE_DOES_NOT_EXIST'	=> 'سرویس تایید اعتباری که وجود ندارد، درخواست شده است.',
	...
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'در حین بروزرسانی نرم افزار داخلی این تالار، امکان بازگردانی کلمه عبور شما وجود ندارد. لطفا %sکلمه عبور جدید%s را درخواست کنید. اگر باز هم مشکلی داشتید، لطفا با %sمدیر کل تالار%s تماس بگیرید.',
	...
	'NOT_WATCHING_FORUM'		=> 'دسترسی برای بروز رساندن این انجمن را ندارید.',
	'NOT_WATCHING_TOPIC'		=> 'دسترسی برای بروز رساندن این موضوع را ندارید.',
	...
	'POST_UNAPPROVED_EXPLAIN'	=> 'این پست برای کاربران دیگر قابل مشاهده نیست. تا زمانی که مدیران آن را تایید کنند.',
