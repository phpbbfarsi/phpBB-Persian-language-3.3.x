...
$lang = array_merge($lang, array(
	...
	'ERR_UNABLE_TO_LOGIN'				=> 'گذرواژه و یا نام کاربری مشخص شده نادرست میباشد.',
	...
	'FOLDER'				=> 'پوشه',
	'FORGOT_PASS'			=> 'گذرواژهم را فراموش کرده ام',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'در این بخش، برای جلوگیری از ورود های مخرب به اکانتتان، اگر بیش از مقدار تایین شده به صورت نادرست گذرواژه و نام کاربریتان را وارد کنید، از شما خواهد خواست که که کد تأیید را وارد کنید. اگر نمیتوانید کد را ببینید و یا بخوانید لطفا با %sمدیر کل تالار%s تماس بگیرید.', // unused
	...
	'LOGIN_ERROR_PASSWORD'				=> 'گذرواژه وارد شده اشتباه میباشد، لطفا گذرواژه خود را برسی کنید و مجددا تلاش کنید. اگر نتوانستید با %sمدیر کل تالار%s تماس بگیرید.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'در حین به‌روز رسانی نرم افزار داخلی این تالار، امکان بازگردانی گذرواژه شما وجود ندارد. لطفا %sگذرواژه جدید%s را درخواست کنید. اگر باز هم مشکلی داشتید، لطفا با %sمدیر کل تالار%s تماس بگیرید.',
