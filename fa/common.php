...
$lang = array_merge($lang, array(
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'در این بخش، برای جلوگیری از ورود های مخرب به اکانتتان، اگر بیش از مقدار تعیین شده به صورت نادرست گذرواژه و نام کاربریتان را وارد کنید، از شما خواهد خواست که که کد تأیید را وارد کنید. اگر نمیتوانید کد را ببینید و یا بخوانید لطفا با %sمدیر کل تالار%s تماس بگیرید.', // unused
