...
$lang = array_merge($lang, array(
	...
	'INSTALL_INTRO_BODY'	=> 'در این قسمت شما می‌توانید برنامه phpBB را در سرور خود نصب کنید.</p><p>برای ادامه مراحل شما به تنظیمات پایگاه داده نیاز دارید. اگر درباره  این موضوع اطلاعاتی ندارید با پشتیبان هاست خود تماس بگیرید. بدون این اطلاعات قادر به ادامه مراحل نیستید شما به این موارد  نیاز دارید:</p>
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '<t>این یک مطلب آزمایشی است.به نظر می رسد که همه چیز به درستی کار می کند. اگر بخواهید می توانید این پست را حذف کنید و برای سازماندهی انجمنتان دست به کار شوید. در طول فرایند نصب، اولین گروه و اولین انجمنتان تشکیل شدند و سطوح دسترسی آن‌ها با توجه به گروه های کاربری پیش‌فرض یعنی مدیران، روبات ها، مدیران انجمن، مهمانان، کاربران عضو شده و کاربران عضو شده COPPA تنظیم شدند. همچنین می‌توانید اولین گروه و اولین انجمنتان را نیز حذف کنید. لطفا تنظیم سطوح دسترسی را در هنگام ایجاد انجمن ها و گروه ها، برای گروه های کاربری  فراموش نکنید. توصیه میشود اولین گروه و اولین انجمن را حذف نکرده و فقط تغییر نام دهید تا هنگام ایجاد انجمن ها و گروه های جدید سطوح دسترسی این دو را به آن‌ها کپی کنید. حال از این انجمن لذت ببرید! <br />چنانچه از نحوه کار با این سیستم اطلاعاتی ندارید و دنبال قالب های شکیل و مدرن به صورت فارسی و  همچنین افزونه های قدرتمند فارسی هستید می‌توانید به مرجع پشتیبانی فارسی phpBB در ایران مراجعه کنید.</t>',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'در این قسمت می‌توانید برنامه phpBB را به آخرین نسخه ارتقا دهید<br />در طی این فرآیند فایل های شما بررسی خواهد شد. تفاوت فایل ها قبل و بعد از آپدیت مشخص خواهد بود.<br /><br />آپدیت فایل ها به دو شیوه خواهد بود.</p><h2>به صورت دستی</h2><p>با این روش شما فایل هایی که تغییر یافته اند را دانلود کرده و به صورت دستی در هاست بارگذاری میکنید و بعد بررسی کنید که فایل ها در جای دقیق خود قرار گرفته اند.</p><h2>به صورت خودکار از طریق FTP</h2><p>این روش شبیه روش اول است اما نیاز به دانلود فایل ها و بارگذاری آن‌ها در هاست نیست. برای انجام این روش باید کار با FTP را بلد باشید و پس از آن شما می‌توانید بررسی کنید که فایل ها در جای خود قرار گرفته اند یا نه.<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '
...
$lang = array_merge($lang, array(
    ...
    'CONVERT_COMPLETE_EXPLAIN'	=> 'انجمن شما با موفقیت به نسخه phpBB 3.3 ارتقا پیدا کرد شما می‌توانید هم اکنوان وارد اکانت خود شوید.<a href="../">دسترسی به انجمن</a>. لطفا قبل از حذف پوشه نصب و فعال سازی انجمن از تغییر تمامی تنظیمات جدید اطمینان حاصل نمایید. راهنمای استفاده از این سیستم در این آدرس موجود است. <a href="https://www.phpbb.com/support/docs/en/3.3/ug/">مستندات</a> و <a href="https://www.phpbb.com/community/viewforum.php?f=661">انجمن پشتیبانی</a>.',
