...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'در این قسمت میتوانید برنامه phpBB را به آخرین نسخه ارتقا دهید<br />در طی این فرآیند فایل های شما بررسی خواهد شد. تفاوت فایل ها قبل و بعد از آپدیت مشخص خواهد بود.<br /><br />آپدیت فایل ها به دو شیوه خواهد بود.</p><h2>به صورت دستی</h2><p>با این روش شما فایل هایی که تغییر یافته اند را دانلود کرده و به صورت دستی در هاست بارگذاری میکنید و بعد بررسی کنید که فایل ها در جای دقیق خود قرار گرفته اند.</p><h2>به صورت خودکار از طریق FTP</h2><p>این روش شبیه روش اول است اما نیاز به دانلود فایل ها و بارگذاری آن‌ها در هاست نیست. برای انجام این روش باید کار با FTP را بلد باشید و پس از آن شما میتوانید بررسی کنید که فایل ها در جای خود قرار گرفته اند یا نه.<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '
