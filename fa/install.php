...
$lang = array_merge($lang, array(
	...
	'INSTALL_RESTART'				=> 'راه‌اندازی مجدد نصب',
));
...
$lang = array_merge($lang, array(
	...
	'INST_ERR_PREFIX'				=> 'جداولی با این پیشوند موجود می باشد، لطفاً آن را تغییر دهید.',
	'INST_ERR_DB_NO_MYSQLI'			=> 'نسخه MYSQL  نصب شده در این دستگاه با گزینه “MySQL همراه با افزونه MySQLi ” که انتخاب کرده اید، ناسازگار است. لطفاً گزینه “MySQL” را انتخاب کنید.',
	...
	'INST_ERR_DB_NO_POSTGRES'		=> 'پایگاه داده انتخاب شده در قالب (encoding) <var>UNICODE</var> یا <var>UTF8</var> ایجاد نشده است. لطفاً نصب پایگاه داده در قالب (encoding) <var>UNICODE</var> یا <var>UTF8</var> امتحان کنید.',
	...
	'UPDATE_INCOMPLETE_MORE'		=> 'لطفاً اطلاعات زیر را جهت رفع خطا بخوانید.',
	...
	//
	// Form labels
	'UPGRADE_INSTRUCTIONS'			=> 'انتشار جدید <strong>%1$s</strong> در دسترس است. لطفاً <a href="%2$s" title="%2$s"><strong>اطلاعیه جدید</strong></a>درباره آنچه منتشر شده و چگونه به‌روز رسانی کنید، را بخوانید.',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '<t>این یک مطلب آزمایشی است.به نظر می رسد که همه چیز به درستی کار می کند. اگر بخواهید می‌توانید این پست را حذف کنید و برای سازماندهی انجمنتان دست به کار شوید. در طول فرایند نصب، اولین گروه و اولین انجمنتان تشکیل شدند و سطوح دسترسی آن‌ها با توجه به گروه‌های کاربری پیش‌فرض یعنی مدیران، ربات ها، مدیران انجمن، مهمانان، کاربران عضو شده و کاربران عضو شده COPPA تنظیم شدند. همچنین می‌توانید اولین گروه و اولین انجمنتان را نیز حذف کنید. لطفاً تنظیم سطوح دسترسی را در هنگام ایجاد انجمن‌ها و گروه‌ها، برای گروه‌های کاربری  فراموش نکنید. توصیه میشود اولین گروه و اولین انجمن را حذف نکرده و فقط تغییر نام دهید تا هنگام ایجاد انجمن‌ها و گروه‌های جدید سطوح دسترسی این دو را به آن‌ها کپی کنید. حال از این انجمن لذت ببرید! <br />چنانچه از نحوه کار با این سیستم اطلاعاتی ندارید و دنبال قالب‌های شکیل و مدرن به صورت فارسی و  همچنین افزونه‌های قدرتمند فارسی هستید می‌توانید به مرجع پشتیبانی فارسی phpBB در ایران مراجعه کنید.</t>',
	...
	'REPORT_OTHER'					=> 'پست گزارش شده شامل هیچکدام از موارد بالا نمی باشد، لطفاً از فیلد اطلاعات بیش تر استفاده کنید.',
...
$lang = array_merge($lang, array(
	...
	'TASK_CLASS_NOT_FOUND'				=> 'سرویس وظیفه نصب کننده نامعتبر است. نام سرویس “%1$s” داده شده است ، فضای نام کلاس مورد انتظار “%2$s” برای آن است. برای اطلاعات بیشتر، لطفاً از مستندات task_interface بازدید کنید.',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>روش پیشنهادی برای به‌روز رسانی، استفاده از بسته کامل است. اگر phpBB شما اصلاح شده باشد، ممکن است بخواهید از بسته به‌روز رسانی پیشرفته استفاده کنید تا این تغییرات را از دست ندهید. همچنین روش های دیگری برا آپدیت وجود دارد که در فایل INSTALL.html می‌توانید مشاهده کنید.آموزش گام به گام به صورت پکیج کامل به صورت زیر است.</p>
			...
			<li>پوشه 
				...
				<ul style="margin-left: 20px; font-size: 1.1em;">
					...
					<li>به‌روز رسانی قالب
						...
						<h1>نحوه به‌روز رسانی نصب با استفاده از بسته های پیشرفته به‌روز رسانی</h1>
						
						<p>روش های توصیه شده برای به‌روز رسانی نصب فقط برای نصب پیشرفته معتبر است. به‌روز رسانی را می‌توانید با استفاده از روش هایی که در  INSTALL.html ذکر شده است نیز انجام دهید. مرحله های به‌روز رسانی خودکار phpBB :</p>
						
						<ol style="margin-left: 20px; font-size: 1.1em;">
					        <li>به 
								<a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">phpBB.com صفحه بارگیری</a> بروید و فایل فشرده "Advanced Update Package" را بارگیری کنید.
								<br />
								<br />
							</li>
...
$lang = array_merge($lang, array(
	'UPDATE_FILES_NOT_FOUND'	=> 'آپدیت معتبری یافت نشد ، لطفاً مطمئن شوید فایل‌ها به درستی بارگذاری شده اند.',
...
$lang = array_merge($lang, array(
	...
	'DEV_NO_TEST_FILE'			=> 'مقداری برای متغیر test_file در تبدیل گر وارد نشده است. اگر کاربری از تبدیل گر هستید نباید این خطا را ببینید.لطفاً با نویسنده تبدیل گر تماس بگیرید. اگر نویسنده تبدیل گر هستید، باید نام فایلی را در تالار قبلی مشخص کنید که مسیر تأیید را مشخص می کند.',
	'COULD_NOT_FIND_PATH'		=> 'مسیر تالار سابق شما یافت نشد، لطفاً تنظیمات را کنترل کرده و دوباره امتحان کنید.<br />» %s به عنوان مسیر مشخص شده است. ',
	'CONFIG_PHPBB_EMPTY'		=> 'متغیر پیکربندی phpBB3 برای “%s” خالی هست.',

	'MAKE_FOLDER_WRITABLE'		=> 'لطفاً اطمینان حاصل کنید که این پوشه موجود و توسط سرور قابل نوشتن است :<br />»<strong>%s</strong>.',
	'MAKE_FOLDERS_WRITABLE'		=> 'لطفاً اطمینان حاصل کنید که این پوشه ها موجود و توسط سرور قابل نوشتن هستند :<br />»<strong>%s</strong>.',
	...
	'CONVERT_INTRO_BODY'		=> 'در این بخش می‌توانید اطلاعات را از سایر سیستم های تالار (نصب شده) انتقال دهید. لیست زیر تمامی افزونه‌های موجود را نمایش میدهد. اگر افزونه سیستم شما در لیست موجود نمی باشد، لطفاً برای جزئیات بیشتر و بارگیری سایر افزونه‌های به سایتمان مراجعه کنید.',
	...
	'DEFAULT_PREFIX_IS'			=> 'تبدیل گر قادر به دریافت جداول با پیشوند خاص نیست. لطفاً اطمینان حاصل کنید که اطلاعات تالار قبلی را به درستی وارد کرده اید. پیشوند پیش‌فرض برای %1$s ،<strong>%2$s</strong>می باشد.',
