...
$lang = array_merge($lang, array(
	...
	<p><strong>توجه:</strong> اگر نصب را با استفاده از SQLite انجام میدهید، باید مسیر کامل به پایگاه داده را در فیلد DSN وارد کنید و فیلد های کلمه عبور و نام کاربری را خالی بگذارید. برای دلایل امنیتی باید مطمئن باشید که پایگاه داده در محلی که از وب قابل دسترسی باشد، ذخیره نشده باشد .</p>
...
$lang = array_merge($lang, array(
	...
	'PHP_SUPPORTED_DB_EXPLAIN'	     	=> '<strong>ضروری</strong> - حداقل باید یک پایگاه داده در سرور پشتیبانی شود. اگر هیچ ماژول پایگاه داده ای نشان داده نشود، برای فعال سازی و جزئیات باید با شرکت خدمات هاستینگ خود تماس بگیرید. و یا توضیحات مربوطه را در مستندات PHP بخوانید. ',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_PASSWORD_EXPLAIN'	=> 'کلمه عبور باید بین 6 تا 30 نویسه باشد.',
	...
	'INST_ERR_PASSWORD_TOO_LONG'	=> 'کلمه عبور وارد شده بسیار طولانی می باشد. حداکثر طول کلمه عبور باید 30 نویسه باشد.',
	'INST_ERR_PASSWORD_TOO_SHORT'	=> 'کلمه عبور وارد شده بسیار کوتاه می باشد. حداقل طول کلمه عبور باید 6 نویسه باشد.',
	...
	'TABLE_PREFIX_EXPLAIN'		=> 'پیشوند باید فقط حاوی حروف باشد و اعداد و کاراکتر ها مجاز نیستند.',
    ...
    'INST_ERR_DB_INVALID_PREFIX'    => 'پیشوند وارد شده معتبر نمی باشد، پیشوند ها باید فقط شامل حروف باشند و اعداد و کاراکتر ها مجاز نیستند.',
	...
	'INST_ERR_DB_NO_SQLITE3'	    => 'نسخه افزونه نصب شده SQLite قدیمی می باشد. باید حداقل به نسخه 3.6.15 بروز رسانی شود.',
	...
	'UPDATE_INCOMPLETE'				=> 'phpBB شما به درستی بروز رسانی نشد',
	'UPDATE_INCOMPLETE_MORE'		=> 'لطفا اطلاعات زیر را جهت رفع خطا بخوانید.',
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>آپدیت به صورت ناقص</h1>

		<p>ما متوجه شدیم که آخرین آپدیت به صورت کامل نصب نشده است. مشاهده کنید <a href="%1$s" title="%1$s">بروز رسانی پایگاه داده</a>, و مطمئن شوید <em>گزینه بروز رسانی پایگاه داده</em> انتخاب شده باشد و روی <strong>ارسال</strong> کلیک کنید. و در آخر پوشه "install"را کاملا پاک کنید</p>',
	//
	// Server data
	//
	// Form labels
	'UPGRADE_INSTRUCTIONS'			=> 'انتشار جدید <strong>%1$s</strong> در دسترس است. لطفا <a href="%2$s" title="%2$s"><strong>اطلاعیه جدید</strong></a>درباره آنچه منتشر شده و چگونه بروز رسانی کنید، را بخوانید.',
...
$lang = array_merge($lang, array(
	...
	'TASK_ADD_DEFAULT_DATA'				=> 'اضافه کردن تنظیمات پیشفرض به پایگاه داده',
...
$lang = array_merge($lang, array(
	...
	'CLI_UPDATE_BOARD'				=> 'بروز رسانی phpBB',
...
$lang = array_merge($lang, array(
	'UPDATE_INSTALLATION'			=> 'بروز رسانی phpBB',
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'در این قسمت میتوانید برنامه phpBB را به آخرین نسخه ارتقا دهید<br />در طی این فرآیند فایل های شما بررسی خواهد شد. تفاوت فایل ها قبل و بعد از آپدیت مشخص خواهد بود.<br /><br />آپدیت فایل ها به دو شیوه خواهد بود.</p><h2>به صورت دستی</h2><p>با این روش شما فایل هایی که تغییر یافته اند را دانلود کرده و به صورت دستی در هاست آپلود میکنید و بعد بررسی کنید که فایل ها در جای دقیق خود قرار گرفته اند.</p><h2>به صورت خودکار از طریق FTP</h2><p>این روش شبیه روش اول است اما نیاز به دانلود فایل ها و آپلود آن ها در هاست نیست. برای انجام این روش باید کار با FTP را بلد باشید و پس از آن شما میتوانید بررسی کنید که فایل ها در جای خود قرار گرفته اند یا نه.<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '

		<h1>اطلاعیه انتشار</h1>

		<p>لطفا <a href="%1$s" title="%1$s"><strong>اطلاعیه ی انتشار نسخه جدید</strong> را قبل از بروز رسانی بخوانید. </a> ممکن است حاوی اطلاعات مفیدی باشد. همچنین در آنجا لینک کامل بارگیری و لیست تغییرات موجود است.</p>

		<br />
 
		<h1>چگونه با استفاده از پکیج کامل phpBB را آپدیت کنیم؟</h1>

		<p>روش پیشنهادی برای بروز رسانی، استفاده از بسته کامل است. اگر phpBB شما اصلاح شده باشد، ممکن است بخواهید از بسته بروز رسانی خودکار استفاده کنید تا این تغییرات را از دست ندهید. همچنین روش های دیگری برا آپدیت وجود دارد که در فایل INSTALL.html میتوانید مشاهده کنید.آموزش گام به گام به صورت پکیج کامل به صورت زیر است.</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li><strong class="error">از فایل های و پایگاه داده خود پشتیبان کامل بگیرید.</strong></li>
			...
			<li>فایل <code class="inline">config.php</code> را حذف کنید, و همچنین پوشه های <code class="inline">/images</code>, <code class="inline">/store</code> و <code class="inline">/files</code> <em>را از پکیج دانلود حذف کنید</em> (از سایت پاک نشود).</li>
			<li>به مرکز مدیریت بروید, در قسمت تنظیمات تالار قالب پیش فرض را پروسیلور قرار دهید.</li>
			<li>پوشه های <code class="inline">/vendor</code> و <code class="inline">/cache</code> را از هاست خود حذف کنید.</li>
			...
			<li><strong><a href="%1$s" title="%1$s">اکنون با مرورگر خود به پوشه <code class="inline">/install</code رفته و فرآیند بروز رسانی را شروع کنید</a>.</strong></li>
			<li>مراحل را برای بروز رسانی پایگاه داده دنبال کنید و اجازه دهید تا کامل شود.</li>
			<li>پوشه <code class="inline">/install</code> را پاک کنید<br><br></li>
		</ol>
		
		<p>حالا انجمن شما با موفقیت بروز رسانی شده. اقدامات زیر را هم انجام دهید:</p>
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>بروز رسانی فایل زبانی</li>
			<li>بروز رسانی قالب<br><br></li>
		</ul>

		<h1>نحوه بروز رسانی نصب با استفاده از بسته های خودکار بروز رسانی</h1>

		<p>روش های توصیه شده برای بروز رسانی نصب فقط برای نصب خودکار معتبر است. بروز رسانی را می توانید با استفاده از روش هایی که در  INSTALL.html ذکر شده است نیز انجام دهید. مرحله های بروز رسانی خودکار phpBB :</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li>به <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">phpBB.com صفحه بارگیری</a> بروید و فایل فشرده "Automatic Update Package" را بارگیری کنید.<br /><br /></li>
			<li>فایل فشرده را از حالت فشردگی خارج کنید<br /><br /></li>
			<li>پوشه های <code class="inline">/install</code> و <code class="inline">/vendor</code> را که از فشردگی خارج کردید، را به روت phpBB بارگذاری کنید .(جایی که config.php وجود دارد)<br /><br /></li>
		</ol>

		<p>هنگامی که پوشه <code class="inline">/install</code بارگذاری شود، تالار برای کاربران معمولی غیرفعال خواهد شد.<br /><br />
		<strong><a href="%1$s" title="%1$s">اکنون با مرورگر خود به پوشه <code class="inline">/install</code رفته و فرآیند بروز رسانی را شروع کنید</a>.</strong><br />
		<br />
		در طول مراحل بروز رسانی راهنمایی خواهید شد و هنگامی که بروز رسانی پایان یابد، اطلاع داده میشود.
		</p>
	',
));
...
$lang = array_merge($lang, array(
	// Updater types
	'UPDATE_TYPE'			=> 'نوع بروز رسانی جهت اجرا',

	'UPDATE_TYPE_ALL'		=> 'بروز رسانی فایل ها و پایگاه داده',
	'UPDATE_TYPE_DB_ONLY'	=> 'تنها آپدیت پایگاه داده',

	// File updater methods
	'UPDATE_FILE_METHOD_TITLE'		=> 'روش بروز رسانی فایل',

	'UPDATE_FILE_METHOD'			=> 'روش بروز رسانی فایل',
	'UPDATE_FILE_METHOD_DOWNLOAD'	=> 'دانلود فایل های تغییر یافته در آرشیو',
	'UPDATE_FILE_METHOD_FTP'		=> 'بروز رسانی فایل ها توسط FTP (خودکار)',
	'UPDATE_FILE_METHOD_FILESYSTEM'	=> 'بروز رسانی فایل ها به صورت مستقیم (خودکار)',
...
$lang = array_merge($lang, array(
	...
	'NO_UPDATE_FILES_UP_TO_DATE'	=> 'نسخه شما بروز می باشد و نیازی به اعمال بروز رسانی نیست. اگر می خواهید از بروز بودن تمامی فایل های موجود اطمینان حاصل کنید، از فایل های مناسب برای بروز رسانی استفاده کنید.',
	'OLD_UPDATE_FILES'		        => 'فایل های بروز رسانی قدیمی هستند. فایل های بروز رسانی برای بروز کردن phpBB %1$s به نسخه phpBB %2$s هستند، ولی آخرین نسخه، phpBB %3$s می باشد.',
	'INCOMPATIBLE_UPDATE_FILES'		=> 'فایل های بروز رسانی یافت شده با نسخه کنونی شما سازگار نیستند. نسخه نصب شده شما %1$s می باشد و نسخه مورد نیاز برای بروز رسانی phpBB بین %2$s تا %3$s می باشد.',
));

// Update files
$lang = array_merge($lang, array(
	'STAGE_UPDATE_FILES'		=> 'بروز رسانی فایل ها',
	...
	// File status
	'UPDATE_CONTINUE_FILE_UPDATE'	=> 'بروز رسانی فایل ها',
	...
	'FILES_MODIFIED_EXPLAIN'		=> 'فایل های مقابل تغییر یافتند و هیچ فایلی از تالار قبلی جایگزین آنها نشد. فایل بروز شده باید توسط شما با فایل های جدید ادغام خواهد شد.',
	...
	'FILES_UP_TO_DATE_EXPLAIN'		=> 'فایل های مقابل بروز هستند و نیازی به بروز رسانی ان ها نیست.',
	'FILES_VERSION'					=> 'نسخه فایل ها',
	'TOGGLE_DISPLAY'				=> 'مشاهده/مخفی لیست فایل',
	
	// File updater
	'UPDATE_UPDATING_FILES'	=> 'بروز رسانی فایل ها',

	'UPDATE_FILE_UPDATER_HAS_FAILED'	=> 'بروز رسانی “%1$s“ نا موفق بود.نصاب مجدد “%2$s“تلاش خواهد کرد',
	'UPDATE_FILE_UPDATERS_HAVE_FAILED'	=> 'به روزرسان فایل ناموفق بود. هیچ روش دیگری وجود ندارد',

	'UPDATE_CONTINUE_UPDATE_PROCESS'	=> 'ادامه مراحل بروز رسانی',
	'UPDATE_RECHECK_UPDATE_FILES'		=> 'بررسی مجدد فایل ها',
));

// Update database
$lang = array_merge($lang, array(
	'STAGE_UPDATE_DATABASE'		=> 'بروز رسانی پایگاه داده',

	'INLINE_UPDATE_SUCCESSFUL'		=> 'بروز رسانی پایگاه داده با موفقیت انجام شد.',
	'TASK_UPDATE_EXTENSIONS'	=> 'بروز رسانی افزونه',
));
...
$lang = array_merge($lang, array(
	...
	'DEV_NO_TEST_FILE'			=> 'مقداری برای متغیر test_file در تبدیل گر وارد نشده است. اگر کاربری از تبدیل گر هستید نباید این خطا را ببینید.لطفا با نویسنده تبدیل گر تماس بگیرید. اگر نویسنده تبدیل گر هستید، باید نام فایلی را در تالار قبلی مشخص کنید که مسیر تایید را مشخص می کند.',
    ...
    'CONVERT_COMPLETE_EXPLAIN'	=> 'انجمن شما با موفقیت به نسخه phpBB 3.3 ارتقا پیدا کرد شما میتوانید هم اکنوان وارد اکانت خود شوید.<a href="../">دسترسی به انجمن</a>. لطفا قبل از حذف پوشه نصب و فعال سازی انجمن از تغییر تمامی تنظیمات جدید اطمینان حاصل نمایید. راهنمای استفاده از این سیستم در این آدرس موجود است. <a href="https://www.phpbb.com/support/docs/en/3.3/ug/">مستندات</a> و <a href="https://www.phpbb.com/community/viewforum.php?f=661">انجمن پشتیبانی</a>.',

	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'در تالار قدیمی، بارگذاری FTP برای پیوست ها فعال می باشد. لطفا بارگذاری پیوست با FTP را غیر فعال کنید و مطمئن شوید که پوشه مشخصی برای بارگذاری تایین شده است. سپس تمام پیوست ها را به این پوشه قابل دسترس بارگذاری کرده و تبدیل گر را دوباره فعال کنید.',
	...
	'CONV_ERROR_PERM_SETTING'			=> 'قرار دادن/بروز رسانی سطوح دسترسی مقدور نیست.',
	...
	'CONV_ERROR_USER_ACCESS'			=> 'دریافت تاییدیه اطلاعات کاربران مقدور نیست.',
