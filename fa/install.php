...
$lang = array_merge($lang, array(
	...
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>آپدیت به صورت ناقص</h1>
		...
		<p>ما متوجه شدیم که آخرین آپدیت به صورت کامل نصب نشده است. مشاهده کنید <a href="%1$s" title="%1$s">بروز رسانی پایگاه داده</a>, و مطمئن شوید <em>گزینه به روز رسانی پایگاه داده</em> انتخاب شده باشد و روی <strong>ارسال</strong> کلیک کنید. و در آخر پوشه "install"را کاملا پاک کنید</p>',
	//
	// Server data
	//
	// Form labels
