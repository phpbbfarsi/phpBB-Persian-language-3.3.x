...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>لطفا <a href="%1$s" title="%1$s"><strong>اطلاعیه ی انتشار نسخه جدید</strong> را قبل از به‌روز رسانی بخوانید. </a> ممکن است حاوی اطلاعات مفیدی باشد. همچنین در آنجا لینک کامل بارگیری و لیست تغییرات موجود است.</p>
		...
		<ol style="margin-left: 20px; font-size: 1.1em;">
			...
			<li><strong><a href="%1$s" title="%1$s">اکنون با مرورگر خود به پوشه <code class="inline">/install</code رفته و فرآیند به‌روز رسانی را شروع کنید</a>.</strong></li>
		...
		<strong><a href="%1$s" title="%1$s">اکنون با مرورگر خود به پوشه <code class="inline">/install</code رفته و فرآیند به‌روز رسانی را شروع کنید</a>.</strong><br />
		<br />
