...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '<t>این یک مطلب آزمایشی است.به نظر می رسد که همه چیز به درستی کار می کند. اگر بخواهید می توانید این پست را حذف کنید و برای سازماندهی انجمنتان دست به کار شوید. در طول فرایند نصب، اولین گروه و اولین انجمنتان تشکیل شدند و سطوح دسترسی آن ها با توجه به گروه های کاربری پیش‌فرض یعنی مدیران، روبات ها، مدیران انجمن، مهمانان، کاربران عضو شده و کاربران عضو شده COPPA تنظیم شدند. همچنین میتوانید اولین گروه و اولین انجمنتان را نیز حذف کنید. لطفا تنظیم سطوح دسترسی را در هنگام ایجاد انجمن ها و گروه ها، برای گروه های کاربری  فراموش نکنید. توصیه میشود اولین گروه و اولین انجمن را حذف نکرده و فقط تغییر نام دهید تا هنگام ایجاد انجمن ها و گروه های جدید سطوح دسترسی این دو را به آنها کپی کنید. حال از این انجمن لذت ببرید! <br />چنانچه از نحوه کار با این سیستم اطلاعاتی ندارید و دنبال قالب های شکیل و مدرن به صورت فارسی و  همچنین افزونه های قدرتمند فارسی هستید میتوانید به مرجع پشتیبانی فارسی phpBB در ایران مراجعه کنید.</t>',
