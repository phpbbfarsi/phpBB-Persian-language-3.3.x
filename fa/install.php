...
$lang = array_merge($lang, array(
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'در تالار قدیمی، بارگذاری FTP برای پیوست ها فعال می باشد. لطفا بارگذاری پیوست با FTP را غیرفعال کنید و مطمئن شوید که پوشه مشخصی برای بارگذاری تایین شده است. سپس تمام پیوست ها را به این پوشه قابل دسترس بارگذاری کرده و تبدیل گر را دوباره فعال کنید.',
