...
$lang = array_merge($lang, array(
	...
	'CLI_DESCRIPTION_REPARSER_REPARSE_OPT_FORCE_BBCODE'	=> 'بدون استثنا همه کدهای BBC را دوباره تجزیه کنید. توجه داشته باشید که همه کدهای BBC که قبلاً غیرفعال شده اند، دوباره پردازش، فعال و به طور کامل ارائه خواهند شد.',	
	...
	'CLI_DESCRIPTION_USER_DELETE_ID'			=> 'حذف حساب های کاربری با شناسه',
	'CLI_DESCRIPTION_USER_DELETE_ID_OPTION_ID'	=> 'شناسه های کاربری کاربران برای حذف',
	...
	'CLI_USER_ADD_SUCCESS'			=> 'کاربر %s با موفقیت اضافه شد.',
	'CLI_USER_DELETE_CONFIRM'		=> 'آیا مطمئنید که می‌خواهید «%s» را حذف کنید؟ [y/N]',
	'CLI_USER_DELETE_ID_CONFIRM'	=> 'آیا مطمئن هستید که می‌خواهید شناسه‌های کاربری «%s» را حذف کنید؟ [y/N]',
	'CLI_USER_DELETE_ID_SUCCESS'	=> 'شناسه های کاربری با موفقیت حذف شد.',
	'CLI_USER_DELETE_ID_START'		=> 'حذف کاربران با شناسه',
	'CLI_USER_DELETE_NONE'			=> 'هیچ کاربری با شناسه کاربری حذف نشد.',
	'CLI_USER_RECLEAN_START'		=> 'پاک کردن مجدد نام های کاربری',
