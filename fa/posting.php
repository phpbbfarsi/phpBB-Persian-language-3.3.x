...
$lang = array_merge($lang, array(
	...
	'DISABLE_SMILIES'			=> 'غیرفعال کردن شکلکک‌ها',
	...
	'POLL_TITLE_COMP_TOO_LONG'	=> 'اندازه عنوان نظرسنجی شما بسیار زیاد است، حذف BBCode و یا شکلکک‌ها را در نظر بگیرید.',
	...
	'SMILIES'					=> 'شکلکک‌ها',
	'SMILIES_ARE_OFF'			=> 'شکلکک‌ها <em>بسته</em> هستند',
	'SMILIES_ARE_ON'			=> 'شکلکک‌ها <em>باز</em> هستند',
