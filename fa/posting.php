...
$lang = array_merge($lang, array(
	...
	'ADD_ATTACHMENT_EXPLAIN'	=> 'اگر مایل به پیوست یک یا چند فایل هستید، لطفاً جزئیات را وارد کنید.',
	'ADD_FILE'					=> 'اضافه کردن فایل',
	'ADD_POLL'					=> 'ایجاد نظرسنجی',
	'ADD_POLL_EXPLAIN'			=> 'اگر نمی خواهید نظرسنجی به موضوع خود اضافه کنید، لطفاً قسمت زیر را خالی بگذارید.',
	...
	'EMPTY_REMOTE_DATA'			=> 'فایل بارگذاری نشد، لطفاً بارگذاری را به صورت دستی امتحان کنید.',
	...
	'POST_CONFIRM_EXPLAIN'		=> 'برای جلوگیری از هرزنامه ها، لطفاً کد تأییدی را که در تصویر زیر نمایش داده میشود، وارد کنید. اگر مشکل بینایی دارید و یا نمی‌توانید کد را وارد کنید، لطفاً با %sمدیر تالار%s تماس بگیرید.',
