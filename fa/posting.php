...
$lang = array_merge($lang, array(
	...
	'CANNOT_DELETE_REPLIED'		=> 'متاسفیم ولی فقط پست هایی را میتوانید حذف کنید که به آن‌ها پاسخ داده نشده باشد.',
	...
	'CANNOT_POST_ANNOUNCE'		=> 'متاسفیم، ولی نمیتوانید اطلاعیه ای را ارسال کنید.',
	'CANNOT_POST_STICKY'		=> 'متاسفیم، ولی نمیتوانید موضوع مهمی را ارسال کنید.',
	...
	'LOAD_DRAFT_EXPLAIN'		=> 'در این بخش میتوانید پیش‌نویس هایی را که مایل به تکمیل کردن آن‌ها هستید، انتخاب کنبد. پست کنونی شما لغو و محتویات آن حذف خواهد شد. برای مشاهده، ویرایش و یا حذف پیش‌نویس ها به کنترل پنل کاربر مراجعه کنید.',
	...
	'MESSAGE_BODY_EXPLAIN'		=> array(
		...
		1	=> 'پیام خودتان را در اینجا وارد کنید، متن پیام نباید بیشتر از <strong>%d</strong> کاراکتر باشد.',
		2	=> 'پیام خودتان را در اینجا وارد کنید، متن پیام نباید بیشتر از <strong>%d</strong> کاراکتر باشد.',
	),
	...
	'POST_CONFIRM_EXPLAIN'		=> 'برای جلوگیری از هرزنامه ها، لطفا کد تأییدی را که در تصویر زیر نمایش داده میشود، وارد کنید. اگر مشکل بینایی دارید و یا نمیتوانید کد را وارد کنید، لطفا با %sمدیر تالار%s تماس بگیرید.',
	...
	'SAVE_DRAFT_CONFIRM'		=> 'توجه داشته باشید که پیش‌نویس ذخیره شده فقط شامل متن و عنوان پست می‌باشد. سایر عناصر حذف خواهند شد. آیا از ذخیره پیش‌نویس مطمئن هستید؟',
	'SMILIES'					=> 'شکلک ها',
	...
	'TOO_MANY_ATTACHMENTS'		=> 'نمیتوانید پیوست دیگری را اضافه کنید. حداکثر تعداد پیوست %d می‌باشد.',
