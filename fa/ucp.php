...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'			=> 'حساب شما با موفقیت به‌روز رسانی شد.در این تالار برای تأیید به‌روز رسانی ایمیل،مدیر باید دوباره اکانت شما را فعال کند.ایمیل مرتبطی به آن‌ها ارسال شد ، ضمنا اسپم باکس ایمیل خود را نیز بررسی کنید و ممکن است رسیدن پیام چند وقتی طول بکشد که بستگی به سرویس ایمیل شما دارد،اگر اکانتتان فعال شود،به شما خبر داده خواهد شد.',
	...
	'ADD_TO'				=> 'افزودن [به]',
	'ADD_USERS_UCP_EXPLAIN'	=> 'در این بخش میتوانید کاربران جدید را به گروه اضافه کنید. همچنین میتوانید این گروه را به عنوان گروه پیش‌فرض برای کاربران انتخاب شده تایین کنید. لطفا هر نام کاربری را در سطری جداگانه وارد کنید.',
	...
	'BOOKMARKS_EXPLAIN'		=> 'شما میتوانید موضوعات را نشانه گذاری کنید تا بعدا به آن‌ها مراجعه کنید، برای پاک کردن نشانک ها بر رو آن‌ها علامت گذاری کرده و سپس بر روی <em>حذف نشانک های انتخاب شده</em> کلیک کنید.',
	...
	'COPPA_EXPLAIN'				=> 'لطفا توجه داشته باشید که اگر کلیک کنید، اکانتتان ایجاد خواهد شد. ولی تا زمانی که خوانواده و یا سرپرست شما آن را تأیید نکند، اکانتتان فعال نخواهد شد. جزئیات فرم درخواست شده و نحوه ارسال آن‌ها به ما به ایمیلتان ارسال شد.',
	...
	'PM_USERS_REMOVED_NO_PM'	=> 'بعضی کاربران اضافه نشدند، زیرا آن‌ها دریافت پیام خصوصی را غیر فعال کرده اند.',
	...
	'UCP_WELCOME'			=> 'به کنترل پنل کاربر خوش آمدید. در اینجا میتوانید بر نمایه، ترجیحات و عضویت هایتان در موضوعات و انجمن های مختلف نظارت و به‌روز رسانی کنید. همچنین میتوانید به سایر کاربران پیام خصوصی بفرستید(اگر این بخش فعال باشد). لطفا قبل از هر اقدامی، اطلاعیه های موجود را بخوانید.',
