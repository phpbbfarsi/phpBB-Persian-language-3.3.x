...
$lang = array_merge($lang, array(
	...
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'گذرواژه باید حداقل %1$s کاراکتر، شامل حروف مختلط ، اعداد و نمادها باشد.',
	'PASSWORD'			=> 'گذرواژه',
	'PASSWORD_ACTIVATED'		=> 'گذرواژه جدیدتان فعال شد.',
	'PASSWORD_RESET'			=> 'گذرواژه شما با موفقیت بازنشانی شد.',
	'PASSWORD_RESET_LINK_SENT'	=> 'چنانچه اکانت شما وجود داشته باشد، لینک بازنشانی گذرواژه به ایمیل شما ارسال میشود. اگر ایمیلی دریافت نکردید، احتمالا اکانت شما اخراج یا غیر فعال شده است. یا همچنین در یک بازه زمانی کوتاه چندین بار عملیات بازنشانی گذرواژه را انجام داده اید و یا اینکه مجوز تغییر گذرواژه را ندارید. در غیر این صورت میتوانید با مدیرت تالار تماس بگیرید و ضمنا پوشه اسپم ایمیل خود را نیز بررسی کنید.',
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'امکان بازنشانی گذرواژه غیر فعال شده است. چنانچه مشکلی در این رابطه دارید، لطفا با %sمدیریت%s تماس بگیرید.',
