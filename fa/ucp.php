...
$lang = array_merge($lang, array(
	...
	'COPPA_EXPLAIN'				=> 'لطفا توجه داشته باشید که اگر کلیک کنید، اکانتتان ایجاد خواهد شد. ولی تا زمانی که خانواده و یا سرپرست شما آن را تأیید نکند، اکانتتان فعال نخواهد شد. جزئیات فرم درخواست شده و نحوه ارسال آن‌ها به ما به ایمیلتان ارسال شد.',
