...
$lang = array_merge($lang, array(
	...
	<br><br>
	اکانت شما داری هویت منحصر به فردی است. (در سطور بعد به عنوان “نام کاربری شما” یاد خواهد شد.)، گذرواژهی (در سطور بعدی به عنوان “yگذرواژه شما”یاد خواهد شد.) و ایمیلی شخصی و معتبر. (در سطور بعدی به عنوان “ایمیل شما” یاد خواهد شد) اطلاعات اکانت شما در “%1$s” توسط نرم افزار حفاظت از اطلاعات شرکتی که ما را میزبانی میکند،حفاظت میشود. این حفاظت شامل نام کاربری،گذرواژه،ایمیل و سایر اطلاعات اجباری و اختیاری در حین ثبت نام در “%1$s” میشود. در هر موردی میتوانید انتخاب کنید که کدام اطلاعات به عموم نمایش داده شود و کدام یک به عموم نمایش داده نشود. و همچنین میتوانید از اکانت خود ایمیل های تولید شده در نرم افزار phpBB را شخصی سازی کنید.
	<br><br>
	گذرواژه شما کدگذاری میشود. (هش(hash) یک طرفه) بنابر این گذرواژه وارد شده همواره امن میباشد. با این وجود،توصیه میشود که از یک گذرواژه در چند وبسایت استفاده نکنید. گذرواژه به معنی دسترسی به اکانتتان در “%1$s” میباشد، بنابر این از گذرواژه خود محافظت کنید،هیچکس تحت هیچ شرایطی در “%1$s”, phpBB یا هر وبسایت دیگری مجاز به پرسیدن گذرواژه شما نیست. اگر گذرواژهتان را فراموش کردید،بر روی لینک “گذرواژهم را فراموش کرده ام” که توسط نرم افزار phpBB تهیه شده است،کلیک کنید. این بخش از شما نام کاربری و ایمیلتان را خواهد خواست تا نرم افزار phpBB بتواند گذرواژه جدیدی به شما ارسال کند و اکانتتان دوباره در دسترس قرار بگیرد.
	',
));
...
$lang = array_merge($lang, array(
	...
	'ADD_TO'				=> 'افزودن [به]',
	'ADD_USERS_UCP_EXPLAIN'	=> 'در این بخش میتوانید کاربران جدید را به گروه اضافه کنید. همچنین میتوانید این گروه را به عنوان گروه پیشفرض برای کاربران انتخاب شده تایین کنید. لطفا هر نام کاربری را در سطری جداگانه وارد کنید.',
	...
	'ATTACHMENT_LOCKED'		=> 'موضوع مورد نظر قفل شده است، نمیتوانید فایل پیوست را حذف کنید.',
	...
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'شما میتوانید آواتار دلخواه خود را از آواتار های محلی موجود انتخاب نمایید.',
	...
	'BOOKMARKS_EXPLAIN'		=> 'شما میتوانید موضوعات را نشانه گذاری کنید تا بعدا به آنها مراجعه کنید، برای پاک کردن نشانک ها بر رو آنها علامت گذاری کرده و سپس بر روی <em>حذف نشانک های انتخاب شده</em> کلیک کنید.',
	...
	'CHANGE_DEFAULT_GROUP'	=> 'ویرایش گروه پیشفرض',
	...
	'VC_REFRESH_EXPLAIN'	=> 'اگر نمیتوانید کد را بخوانید، میتوانید با کلیک بر روی دکمه، کد جدیدی را درخواست کنید.',
	...
	'COPPA_EXPLAIN'				=> 'لطفا توجه داشته باشید که اگر کلیک کنید، اکانتتان ایجاد خواهد شد. ولی تا زمانی که خوانواده و یا سرپرست شما آن را تأیید نکند، اکانتتان فعال نخواهد شد. جزئیات فرم درخواست شده و نحوه ارسال آنها به ما به ایمیلتان ارسال شد.',
	...
	'DEFAULT_ADD_SIG'			=> 'امضای مرا به صورت پیشفرض ضمیمه کن',
	...
	'DELETE_ATTACHMENTS_CONFIRM'	=> 'آیا از حذف پیوست ها اطمینان دارید؟',
	...
	'DELETE_MARKED_PM_CONFIRM'	=> 'آیا از حذف پیام های نشانه گذاری شده اطمینان دارید؟',
	'DELETE_OLDEST_MESSAGES'	=> 'حذف پیام های قدیمی',
	'DELETE_MESSAGE'			=> 'حذف پیام',
	'DELETE_MESSAGE_CONFIRM'	=> 'آیا از حذف این پیام خصوصی اطمینان دارید؟',
	'DELETE_MESSAGES_IN_FOLDER'	=> 'تمام پیام های پوشه حذف شده ها را پاک کنید.',
	'DELETE_RULE'			=> 'حذف قانون',
	'DELETE_RULE_CONFIRM'	=> 'آیا از حذف این قانون اطمینان دارید؟',
	...
	'FIELD_INVALID_CHARS_ALPHA_DOTS'		=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا و اعداد مورد قبول هستند.',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'		=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا و اعداد مورد قبول هستند.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا یا کاراکترهای _,-. مجاز است و اولین کاراکتر باید یک حرف باشد.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'		=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا و خط فاصله یا کاراکترهای -+_[] مجاز است.',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، تنها حروف الفبا یا کاراکتر _ مجاز است.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، تنها حروف الفبا و اعداد و نقطه مجاز است.',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'  	=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا و اعداد مجاز است.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا و اعداد یا کاراکترهای _,-. مجاز است و اولین کاراکتر باید یک حرف باشد.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'	=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا و اعداد و خط فاصله و کاراکتر های -+_[] مجاز است.',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'	=> 'قسمت “%s” حاوی کاراکترهای غیر مجاز است، فقط حروف الفبا و اعداد و کاراکتر _ مجاز است.',
	...
	'FOE_MESSAGE'			=> 'پیام از دشمن',
	'FOES_EXPLAIN'			=> 'دشمنان، کاربرانی هستند که به طور پیشفرض نادیده گرفته خواهند شد. پستهای این کاربران برای شما قابل مشاهده نخواهد بود، ولی این قاعده در مورد پیامهای خصوصی جاری نیست. توجه داشته باشید که شما نمی توانید مدیرهای انجمن یا مدیران سایت را وارد این لیست کنید.',
	...
	'FOLDER_STATUS_MSG'		=> array(
		1	=> 'پوشه شما پر است %3$d%% (%2$d از %1$s پیام ذخیره شده)',
		2	=> 'پوشه شما پر است %3$d%% (%2$d از %1$s پیام ذخیره شده)',
	),
	'FORWARD_PM'				=> 'ارسال پیام به دیگران',
	'FORCE_PASSWORD_EXPLAIN'	=> 'برای ادامه فعالیت در تالار، باید گذرواژهتان را تغییر دهید.',
	'FRIEND_MESSAGE'			=> 'پیامی از طرف دوستان',
	'FRIENDS'					=> 'دوستان',
	...
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'طول و عرض گراواتار خود را مشخص کنید یا میتوانید با خالی گذاشتن آن به صورت خودکار تعیین شود.',
	...
	'INVALID_EMOJIS_USERNAME'	=> 'نام کاربری حاوی کاراکترهای غیر مجاز (Emoji) است.',
	'INVALID_CHARS_NEW_PASSWORD'	=> 'گذرواژه حاوی کاراکتر های درخواست شده نیست.',
	...
	'LINK_REMOTE_SIZE_EXPLAIN'	=> 'طول و عرض آواتار خود را مشخص کنید یا میتوانید با خالی گذاشتن آن به صورت خودکار تعیین شود.',
	...
	'MARKED_MESSAGE'			=> 'پیام علامت گذاری شده',
	...
	'MESSAGE_REPORTED_MESSAGE'	=> 'پیام های گزارش شده',
	'MESSAGE_SENT_ON'			=> 'در',
	...
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'		=> 'پست یا موضوعی منتظر تأیید است.',
	...
	'NOT_ADDED_FRIENDS_ANONYMOUS'	=> 'نمیتوانید کاربری ناشناس را به لیست دوستانتان اضافه کنید.',
	...
	'NOT_ADDED_FOES_ANONYMOUS'		=> 'نمیتوانید کاربری ناشناس را به لیست دشمنانتان اضافه کنید.',
	...
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'نمیتوانید این پیام را بخوانید زیرا توسط نویسنده آن حذف شده است.',
	...
	'NO_PASSWORD_SUPPLIED'	=> 'بدون گذرواژه نمیتوانید وارد شوید.',
	'NO_RECIPIENT'			=> 'گیرنده ای مشخص نشده است.',
	'NO_RESET_TOKEN'		=> 'شما برای بازیابی گذرواژه، نشانه ای ارائه نکردید',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'گذرواژه باید حداقل  %1$s کاراکتر، شامل حروف مختلط و اعداد باشد.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'گذرواژه باید حداقل %1$s کاراکتر باشد',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'گذرواژه باید حداقل  %1$s کاراکتر شامل حروف مختلط باشد.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'گذرواژه باید حداقل %1$s کاراکتر، شامل حروف مختلط ، اعداد و نماد ها باشد.',
	'PASSWORD'			=> 'گذرواژه',
	'PASSWORD_ACTIVATED'		=> 'گذرواژه جدیدتان فعال شد.',
	'PASSWORD_RESET'			=> 'گذرواژه شما با موفقیت بازیابی شد.',
	'PASSWORD_RESET_LINK_SENT'	=> 'چنانچه اکانت شما وجود داشته باشد، لینک بازیابی گذرواژه به ایمیل شما ارسال میشود. اگر ایمیلی دریافت نکردید احتمالا اکانت شما اخراج یا غیر فعال شده است. یا همچنین در یک بازه زمانی کوتاه چندین بار عملیات بازیابی گذرواژه را انجام داده اید و یا اینکه مجوز تغییر گذرواژه را ندارید. در غیر صورت میتوانید با مدیرت تالار تماس بگیرید و ضمنا پوشه اسپم ایمیل خود را نیز بررسی کنید',
	...
	'PM_DISABLED'				=> 'بخش پیام خصوصی در این تالار غیر فعال شده است.',
	'PM_FROM'			=> 'از طرف',
	...
	'PM_USERS_REMOVED_NO_PM'	=> 'بعضی کاربران اضافه نشدند، زیرا آنها دریافت پیام خصوصی را غیر فعال کرده اند.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'کلید ورودی "مرا به خاطر بسپار" به صورت خودکار شما را هنگامی که در انجمن هستید در داخل نگه میدارد. هنگامیکه شما خارج میشوید کلید ورود حذف میشود. در این قسمت شما میتوانید کلید های ورودی مربوط به کامپیوتری که با آن وارد انجمن شده اید را مشاهده کنید.',
	...
	'RELEASE_MESSAGES'		=> '%sانتشار همه پیام های درحال انتظار%s… اگر فضای کافی ایجاد شود، به پوشه ی مربوطه منتقل خواهند شد.',
	...
	'SAME_PASSWORD_ERROR'	=> 'گذرواژه وارد شده با گذرواژه فعلی شما یکسان میباشد.',
	...
	'SIGNATURE_EXPLAIN'		=> 'امضا بلوکی از متن است که در هر پست شما نمایش داده میشود، محدودیت %d کاراکتر وجود است.',
	...
	'UCP_ADMIN_ACTIVATE'	=> 'توجه داشته باشید که قبل از ثبت نام باید ایمیل معتبری را وارد کنید. مدیر اکانت شما را بررسی خواهد کرد و در صورت تأیید ایمیلی به آدرس ایمیلتان ارسال خواهد شد.',
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'امکان بازیابی گذرواژه غیر فعال شده است. چنانچه مشکلی در این رابطه دارید، لطفا با %sمدیریت%s تماس بگیرید.',
	'UCP_REGISTER_DISABLE'	=> 'ایجاد حساب کاربری جدید ممکن نیست.',
	'UCP_RESEND'			=> 'ارسال ایمیل فعال سازی',
	'UCP_WELCOME'			=> 'به کنترل پنل کاربر خوش آمدید. در اینجا میتوانید بر پروفایل، ترجیحات و عضویت هایتان در موضوعات و انجمن های مختلف نظارت و به‌روز رسانی کنید. همچنین میتوانید به سایر کاربران پیام خصوصی بفرستید(اگر این بخش فعال باشد). لطفا قبل از هر اقدامی، اطلاعیه های موجود را بخوانید.',
	...
	'WATCHED_EXPLAIN'		=> 'این لیستی از انجمن ها و موضوعاتی میباشد که در آن عضو شده اید. از پست های جدید در این انجمن ها با خبر خواهید شد. برای لغو عضویت بر روی موضوع و یا انجمن علامت بگذارید و سپس بر روی <em>لغو عضویت در انتخاب شده ها</em> کلیک کنید.',
