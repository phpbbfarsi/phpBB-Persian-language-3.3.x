...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'با دسترسی به “%1$s” (در سطور بعد “ما”, “%1$s”, “%2$s” را بیان دارد)، پیروی از قوانین مقابل را قبول می‌کنید. اگر این قوانین را قبول ندارید لطفاً از “%1$s” استفاده نکنید. این قوانین در هر زمانی ممکن است تغییر کند و ما تمام سعی خودمان را خواهیم کرد که این تغییرات را به شما اطلاع دهیم، با این وجود باید قوانین موجود را در بازه‌های زمانی منظم کنترل کنید و از تغییرات آگاه شوید. اگر قوانین موجود در “%1$s” تغییر کند و شما به استفاده از آن ادامه دهید، این بدان معنا خواهد بود که شما این قوانین را پذیرفته‌اید.
	<br><br>
	انجمن‌های ما توسط phpBB ایجاد شده‌اند (در سطور بعدی “آن‌ها”, “نرم‌افزار phpBB”, “www.phpbb.com”, “گروه phpBB”, “تیم phpBB” را بیان می‌کند) که تحت لایسنس “<a href="http://opensource.org/licenses/gpl-2.0.php">General Public License</a>” فعالیت می‌کند و از <a href="http://www.phpbb.com/">www.phpbb.com</a> قابل بارگیری است. نرم‌افزار phpBB تنها نرم‌افزاری است برای تسهیل بحث و گفتگو در اینترنت. گروه phpBB مسئول هیچگونه محتوا و یا رفتاری که مورد تأیید یا عدم تأیید phpBB باشد، نیست. برای اطلاعات بیشتر در مورد phpBB لطفاً به آدرس <a href="http://www.phpbb.com/">http://www.phpbb.com/</a> مراجعه کنید.
	<br><br>
	انجمن‌های ما توسط php-BB فارسی‌سازی شده‌اند. (در سطور بعدی “آن‌ها”, “www.php-bb.ir”, “تیم php-bb” را بیان می‌کند.) <a href="http://www.php-bb.ir">php-bb</a> تنها این نرم‌افزار را فارسی‌سازی کرده است و هیچ‌گونه مسئولیتی در قبال مطالب و محتوای موجود در سایت‌های استفاده‌کننده از آن ندارد. برای اطلاعات بیشتر به <a href="http://www.php-bb.ir">www.php-bb.ir</a> مراجعه کنید.
	<br><br>
	شما موافقت می‌کنید که مطالب مستهجن، مبتذل، افترا آمیز، توهین‌آمیز، تهدیدکننده و هرگونه مطلب مخالف با قوانین کشورتان و قوانینی که “%1$s” در آن کشور میزبان شده است و همچنین قوانین بین‌الملل، ارسال نکنید. در غیر این صورت به طور سریع و همیشگی تحریم خواهید شد. اگر از جانب سرویس‌دهی اینترنت شما، نامه‌ای مبنی بر تخلف شما دریافت کنیم، این تالار حق تحریم شما را دارد. موافقت می‌کنید که “%1$s” حق ویرایش، حذف، انتقال و قفل کردن موضوعات را در هر زمانی داراست. طبق موافقت‌نامه تمامی اطلاعات وارد شده شما در تالار در پایگاه داده ما ذخیره خواهد شد. این اطلاعات به هیچ وجه با سایتی دیگر به اشتراک گذاشته نخواهد شد. با این وجود “%1$s”.
	',

	'PRIVACY_POLICY'	=> 'این سیاست توضیحی است برای “%1$s” همراه با شرکت وابسته (در سطور بعد به عنوان “ما”, “%1$s”, “%2$s” یاد خواهد شد) و phpBB (در سطور بعد “آن‌ها”, “phpBB نرم‌افزار”, “www.phpbb.com”, “phpBB گروه”, “phpBB تیم”) که چگونه اطلاعات شما را جمع‌آوری می‌کنند (در سطور بعدی به عنوان “اطلاعات شما” یاد خواهد شد).
	<br><br>
	اطلاعات شما به دو روش جمع‌آوری می‌شوند: اول، جست‌وجو در “%1$s” موجب ایجاد کوکی‌هایی می‌شود که فایل‌های کوچکی هستند و به فایل‌های موجود مرورگرتان بارگیری می‌شوند. دو کوکی اول فقط حاوی هویت شما هستند (در سطور بعدی به عنوان “user-id” یاد خواهد شد) و هویت نشست بی‌هویت (در سطور بعدی به عنوان “session-id” یاد خواهد شد)، به صورت خودکار توسط phpBB فراهم شده است. کوکی سوم هنگام جست‌وجوی موضوعات “%1$s” ایجاد می‌شود و اطلاعاتی از قبیل مشخص کردن موضوعات خوانده شده را ذخیره می‌کند.
	<br><br>
	ممکن است نرم‌افزار phpBB در حین جست‌وجوی “%1$s”، کوکی‌های خارجی هم ایجاد کند. با این وجود این کوکی‌ها خارج از حوزه این سند که صفحات ایجاد شده توسط phpBB را پوشش می‌دهد، قرار دارند. راه دوم جمع‌آوری اطلاعات از شما، اطلاعاتی است که شما به ما ارسال می‌کنید. این اطلاعات ممکن است وجود نداشته باشد و همچنین محدود به این اطلاعات نیستند: ارسالات کاربران بی‌هویت (در سطور بعدی به عنوان “پست‌های بی‌هویت” یاد خواهد شد)، ثبت نام در “%1$s” (در سطور بعدی به عنوان “حساب شما” یاد خواهد شد) و پست‌هایی که توسط شما و بعد از ثبت نام و ورود ایجاد می‌شوند (در سطور بعدی به عنوان “پست‌های شما” یاد خواهد شد).
	<br><br>
	حساب شما دارای هویت منحصر به فردی است (در سطور بعد به عنوان “نام کاربری شما” یاد خواهد شد)، گذرواژه‌ای (در سطور بعدی به عنوان “گذرواژه شما” یاد خواهد شد) و ایمیلی شخصی و معتبر. اطلاعات حساب شما در “%1$s” توسط نرم‌افزار حفاظت از اطلاعات شرکتی که ما را میزبانی می‌کند، محافظت می‌شود. این حفاظت شامل نام کاربری، گذرواژه، ایمیل و سایر اطلاعات اجباری و اختیاری در حین ثبت نام در “%1$s” می‌شود. در هر موردی می‌توانید انتخاب کنید که کدام اطلاعات به عموم نمایش داده شود و کدام یک به عموم نمایش داده نشود. همچنین می‌توانید از حساب خود ایمیل‌های تولید شده در نرم‌افزار phpBB را شخصی‌سازی کنید.
	<br><br>
	گذرواژه شما کدگذاری می‌شود (هش hash یک طرفه) بنابراین گذرواژه وارد شده همواره امن می‌باشد. با این وجود، توصیه می‌شود که از یک گذرواژه در چند وبسایت استفاده نکنید. گذرواژه به معنی دسترسی به حسابتان در “%1$s” می‌باشد، بنابراین از گذرواژه خود محافظت کنید. هیچکس تحت هیچ شرایطی در “%1$s”، phpBB یا هر وب‌سایت دیگری مجاز به پرسیدن گذرواژه شما نیست. اگر گذرواژه‌تان را فراموش کردید، بر روی لینک “گذرواژه‌ام را فراموش کرده‌ام” که توسط نرم‌افزار phpBB تهیه شده است، کلیک کنید. این بخش از شما نام کاربری و ایمیل‌تان را خواهد خواست تا نرم‌افزار phpBB بتواند گذرواژه جدیدی به شما ارسال کند و حسابتان دوباره در دسترس قرار بگیرد.
	',
));
