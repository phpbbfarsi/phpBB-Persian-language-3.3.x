...
$lang = array_merge($lang, array(
	...
	'ADD_TO'				=> 'افزودن [به]',
	'ADD_USERS_UCP_EXPLAIN'	=> 'در این بخش میتوانید کاربران جدید را به گروه اضافه کنید. همچنین میتوانید این گروه را به عنوان گروه پیش‌فرض برای کاربران انتخاب شده تعیین کنید. لطفا هر نام کاربری را در سطری جداگانه وارد کنید.',
	...
	'FIELD_TOO_LONG'		=> array(
		1	=> 'قسمت “%1$s” بسیار طولانی است، میتوانید حداکثر %2$d نویسه وارد کنید.',
		2	=> 'قسمت “%1$s” بسیار طولانی است، میتوانید حداکثر %2$d نویسه وارد کنید.',
	),
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'گذرواژه باید حداقل  %1$s نویسه، شامل حروف مختلط و اعداد باشد.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'گذرواژه باید حداقل %1$s نویسه باشد.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'گذرواژه باید حداقل  %1$s نویسه شامل حروف مختلط باشد.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'گذرواژه باید حداقل %1$s نویسه، شامل حروف مختلط ، اعداد و نمادها باشد.',
	'PASSWORD'			=> 'گذرواژه',
