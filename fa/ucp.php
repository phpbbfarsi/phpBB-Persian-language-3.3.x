...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'حساب شما با موفقیت به‌روز رسانی شد.در این تالار برای تایید به‌روز رسانی ایمیل،لینک فعال سازی دوباره به ایمیلتان ارسال میشود.لطفا برای فعال کردن دوباره به ایمیل جدیدتان مراجعه کنید.',
	'ACCOUNT_INACTIVE'			=> 'حساب شما با موفقیت به‌روز رسانی شد.در این تالار برای تایید به‌روز رسانی ایمیل،مدیر باید دوباره اکانت شما را فعال کند.ایمیل مرتبطی به آنها ارسال شد ، ضمنا اسپم باکس ایمیل خود را نیز بررسی کنید و ممکن است رسیدن پیام چند وقتی طول بکشد که بستگی به سرویس ایمیل شما دارد،اگر اکانتتان فعال شود،به شما خبر داده خواهد شد.',
