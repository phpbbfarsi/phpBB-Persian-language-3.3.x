...
'TERMS_OF_USE_CONTENT'	=> 'با دسترسی به “%1$s” (از این پس “ما”، “ما را”، “مال ما”، “%1$s”، “%2$s”)، شما با شرایط زیر موافقت می‌کنید که از نظر قانونی برای شما الزام‌آور است. اگر با تمام شرایط زیر موافقت نمی‌کنید، لطفاً به “%1$s” دسترسی پیدا نکنید یا از آن استفاده نکنید. ما ممکن است این شرایط را در هر زمان تغییر دهیم و تمام تلاش خود را خواهیم کرد تا شما را از چنین تغییراتی مطلع سازیم. با این حال، بررسی منظم این سند مسئولیت شماست، زیرا استفادهٔ مستمر شما از “%1$s” پس از اعمال تغییرات به منزلهٔ موافقت شما با شرایط به‌روزرسانی‌شده و/یا اصلاح‌شده از نظر قانونی محسوب می‌شود.
	<br><br>
	انجمن‌های ما توسط phpBB (از این پس “آنها”، “آنها را”، “مال آنها”، “نرم‌افزار phpBB”، “www.phpbb.com”، “phpBB Limited”، “تیم‌های phpBB”) پشتیبانی می‌شوند، که یک راه‌حل تالار گفتگو است که تحت مجوز “<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>” (از این پس “GPL”) منتشر شده است و می‌توان آن را از <a href="https://www.phpbb.com/">www.phpbb.com</a> دانلود کرد. نرم‌افزار phpBB فقط بحث‌های مبتنی بر اینترنت را تسهیل می‌کند؛ phpBB Limited مسئولیتی در قبال محتوا یا رفتاری که در این سایت مجاز یا غیرمجاز است ندارد. برای اطلاعات بیشتر درباره phpBB، لطفاً مشاهده کنید: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	شما موافقت می‌کنید که هیچ مطلب توهین‌آمیز، مبتذل، رکیک، افتراآمیز، نفرت‌انگیز، تهدیدآمیز، با گرایش جنسی، یا غیرقانونی منتشر نکنید، چه طبق قوانین کشور شما، چه کشوری که “%1$s” در آن میزبانی می‌شود، و چه طبق قوانین بین‌المللی. انجام چنین کاری ممکن است منجر به ممنوعیت فوری و دائمی شما شود و در صورت لزوم از دیدگاه ما، ارائه‌دهنده خدمات اینترنت شما مطلع گردد. آدرس IP همه پست‌ها برای کمک به اجرای این شرایط ثبت می‌شود.
	<br><br>
	شما موافقت می‌کنید که “%1$s” این حق را برای خود محفوظ می‌دارد که هر زمان و با اختیار کامل خود، هر موضوعی را حذف، ویرایش، انتقال یا ببندد. به عنوان یک کاربر، شما موافقت می‌کنید که هر اطلاعاتی که وارد می‌کنید ممکن است در یک پایگاه داده ذخیره شود. در حالی که این اطلاعات بدون رضایت شما در اختیار هیچ شخص ثالثی قرار نخواهد گرفت، نه “%1$s” و نه phpBB در قبال هیچ تلاشی برای هک که منجر به به خطر افتادن داده‌ها شود مسئول شناخته نخواهند شد.
	',

	'PRIVACY_POLICY'		=> 'این سیاست به طور دقیق توضیح می‌دهد که چگونه “%1$s” و شرکت‌های وابسته به آن (از این پس “ما”، “ما را”، “مال ما”، “%1$s”، “%2$s”) و phpBB (از این پس “آنها”، “آنها را”، “مال آنها”، “نرم‌افزار phpBB”، “www.phpbb.com”، “phpBB Limited”، “تیم‌های phpBB”) از اطلاعات جمع‌آوری‌شده در طول استفاده شما از این سایت (از این پس “اطلاعات شما”) استفاده می‌کنند.
	<br><br>
	اطلاعات شما به دو روش جمع‌آوری می‌شود. هنگامی که در “%1$s” مرور می‌کنید، نرم‌افزار phpBB چندین کوکی ایجاد خواهد کرد. کوکی‌ها فایل‌های متنی کوچکی هستند که در فایل‌های موقت مرورگر وب شما ذخیره می‌شوند. دو کوکی اول شامل یک شناسه کاربر (از این پس “user-id”) و یک شناسه جلسهٔ ناشناس (از این پس “session-id”) هستند که هر دو به طور خودکار توسط نرم‌افزار phpBB اختصاص داده می‌شوند. یک کوکی سوم پس از مرور موضوعات در “%1$s” ایجاد خواهد شد. اطلاعاتی را درباره موضوعاتی که خوانده‌اید ذخیره می‌کند و در نتیجه تجربه کاربری شما را بهبود می‌بخشد.
	<br><br>
	همچنین ممکن است در حین مرور “%1$s”، کوکی‌هایی خارج از نرم‌افزار phpBB ایجاد کنیم. این موارد خارج از محدوده این سند هستند که فقط کوکی‌های ایجاد شده توسط نرم‌افزار phpBB را پوشش می‌دهد.
	<br><br>
	روش دوم جمع‌آوری اطلاعات از طریق آن چیزی است که شما برای ما ارسال می‌کنید. این شامل موارد زیر است اما به آنها محدود نمی‌شود: ارسال پست به عنوان کاربر ناشناس (از این پس “پست‌های ناشناس”)، ثبت‌نام در “%1$s” (از این پس “حساب کاربری شما”)، پست‌هایی که پس از ثبت‌نام و در حالی که وارد سیستم شده‌اید ارسال می‌کنید (از این پس “پست‌های شما”).
	<br><br>
	حساب کاربری شما حداقل شامل موارد زیر خواهد بود: یک نام کاربری منحصربه‌فرد (از این پس “نام کاربری شما”)، یک رمز عبور شخصی که برای ورود به سیستم استفاده می‌شود (از این پس “رمز عبور شما”)، یک آدرس ایمیل معتبر (از این پس “ایمیل شما”). اطلاعات حساب کاربری شما در “%1$s” توسط قوانین حفاظت از داده‌های قابل اجرا در کشوری که ما را میزبانی می‌کند محافظت می‌شود. هر اطلاعاتی فراتر از نام کاربری، رمز عبور و آدرس ایمیل شما که در طول ثبت‌نام درخواست می‌شود ممکن است اجباری یا اختیاری باشد که این موضوع با اختیار “%1$s” تعیین می‌شود. در همه حالات، شما می‌توانید انتخاب کنید چه اطلاعاتی از حساب کاربری شما به صورت عمومی نمایش داده شود. همچنین می‌توانید ایمیل‌های تولید شده خودکار توسط نرم‌افزار phpBB را فعال یا غیرفعال کنید.
	<br><br>
	رمز عبور شما برای اطمینان از امنیت، به صورت هش یک‌طرفه ذخیره می‌شود. با این حال، توصیه می‌کنیم که رمز عبور یکسانی را در چندین وب‌سایت استفاده مجدد نکنید. رمز عبور شما کلید دسترسی به حساب کاربری شما در “%1$s” است، بنابراین لطفاً آن را ایمن نگه دارید. تحت هیچ شرایطی هیچ فرد وابسته به “%1$s”، phpBB، یا هیچ شخص ثالث قانونی، رمز عبور شما را درخواست نخواهد کرد. اگر رمز عبور خود را فراموش کردید، می‌توانید از قابلیت “رمز عبورم را فراموش کرده‌ام” ارائه شده توسط نرم‌افزار phpBB استفاده کنید. این فرآیند از شما می‌خواهد که نام کاربری و آدرس ایمیل خود را ارائه دهید، پس از آن نرم‌افزار phpBB یک رمز عبور جدید برای شما ایجاد می‌کند تا دسترسی خود را به حساب کاربری خود بازگردانید.
	',
));
