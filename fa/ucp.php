...
$lang = array_merge($lang, array(
	...
	'DELETE_ATTACHMENTS_CONFIRM'	=> 'آیا از حذف پیوست ها مطمئن هستید؟',
	...
	'DELETE_MARKED_PM_CONFIRM'	=> 'آیا از حذف پیام های نشانه گذاری شده مطمئن هستید؟',
	'DELETE_OLDEST_MESSAGES'	=> 'حذف پیام های قدیمی',
	'DELETE_MESSAGE'			=> 'حذف پیام',
	'DELETE_MESSAGE_CONFIRM'	=> 'آیا از حذف این پیام خصوصی مطمئن هستید؟',
	...
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'		=> 'آیا از نشانه گذاری همه اعلانات به عنوان خوانده شده مطمئن هستید؟',
    ...
    'PERMISSIONS_TRANSFERRED'	=> 'با موفقیت سطوح دسترسی از <strong>%s</strong>منتقل شدند، حال با سطوح دسترسی این کاربر می‌توانید در تالار فعالیت کنید.<br />توجه داشته باشید که سطوح دسترسی مدیر منتقل نشد، در هر زمانی می‌توانید به سطوح دسترسی خودتان بازگردید.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'کلید ورودی "مرا به خاطر بسپار" به صورت خودکار شما را هنگامی که در انجمن هستید در داخل نگه میدارد. هنگامیکه شما خارج میشوید کلید ورود حذف میشود. در این قسمت شما می‌توانید کلید های ورودی مربوط به کامپیوتری که با آن وارد انجمن شده اید را مشاهده کنید.',
	...
	'UCP_NOTIFICATION_LIST_EXPLAIN'	=> 'در این قسمت شما می‌توانید تمام اعلانات را مشاهده کنید.',
	'UCP_NOTIFICATION_OPTIONS'		=> 'تنظیمات اعلانات',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'در این قسمت شما می‌توانید تنظیمات مربوط به اعلانات را انجام دهید.',
