...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_COPPA'			=> 'حساب شما ایجاد شد ولی باید تایید گردد، لطفا دیگر اطلاعات را از ایمیل خود چک کنید.',
	...
	'COPPA_BIRTHDAY'			=> 'برای ادامه ثبت نام، لطفا تاریخ تولد خود به ما بگویید؟',
	...
	'CURRENT_PASSWORD_EXPLAIN'		=> 'برای تغییر ایمیل یا نام کاربری باید کلمه عبور فعلی خود را وارد کنید.',
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'در هنگام تغییر کلمه عبور، تغییر آدرس ایمیل یا تغییر نام کاربری باید کلمه عبور فعلی خود را وارد کنید.',
	'CUR_PASSWORD_EMPTY'		=> 'کلمه عبور فعلی خود را وارد نکردید.',
	'CUR_PASSWORD_ERROR'		=> 'کلمه عبور فعلی شما که وارد کردید اشتباه است',
	...
	'DELETE_COOKIES_CONFIRM'		=> 'آیا مطمئنید همه كوكی ها پاك شوند؟ این كار باعث خروج شما از انجمن می شود و باید دوباره وارد شوید.',
	...
	'FOES_EXPLAIN'				=> 'دشمنان، كاربرانی هستند كه به طور پیشفرض نادیده گرفته خواهند شد. پستهای این كاربران برای شما قابل مشاهده نخواهد بود ولی این قاعده در مورد پیامهای خصوصی جاری نیست. توجه داشته باشید كه شما نمی توانید مدیرهای انجمن یا مدیران سایت را وارد این لیست كنید.',
	...
	'INVALID_CHARS_NEW_PASSWORD'	=> 'کلمه عبور حاوی کاراکتر های درخواست شده نیست.',
	...
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'هیچ داده ای برای پیوند دادن حساب خارجی به حساب انجمن در این صفحه ارائه نشده است. اگر همچنان با مشكل مواجه شدید، با مدیرت انجمن تماس بگیرید.',
	'LOGIN_KEY'				=> 'کلید ورود',
	...
	'NOTIFICATION_TYPE_MODERATION_QUEUE'   		=> 'موضوع یا پست شما توسط مدیری تایید یا رد شده است.',
	...
	'NO_RESET_TOKEN'			=> 'شما برای بازیابی پسورد، نشانه ای ارائه نکردید',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'		=> 'کلمه عبور باید حداقل  %1$s کاراکتر، شامل حروف مختلط و اعداد باشد.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'کلمه عبور باید حداقل %1$s کاراکتر باشد',
	'PASS_TYPE_CASE_EXPLAIN'		=> 'کلمه عبور باید حداقل  %1$s کاراکتر شامل حروف مختلط باشد.',
	'PASS_TYPE_SYMBOL_EXPLAIN'		=> 'کلمه عبور باید حداقل %1$s کاراکتر، شامل حروف مختلط ، اعداد و نماد ها باشد.',
	'PASSWORD'				=> 'کلمه عبور',
	'PASSWORD_ACTIVATED'		=> 'کلمه عبور جدیدتان فعال شد.',
	'PASSWORD_RESET'			=> 'کلمه عبور شما با موفقیت بازیابی شد.',
	'PASSWORD_RESET_LINK_SENT'		=> 'چنانچه اکانت شما وجود داشته باشد، لینک بازیابی پسورد به ایمیل شما ارسال میشود. اگر ایمیلی دریافت نکردید احتمالا اکانت شما اخراج یا غیر فعال شده است. یا همچنین در یک بازه زمانی کوتاه چندین بار عملیات بازیابی پسورد را انجام داده اید و یا اینکه مجوز تغییر پسورد را ندارید. در غیر صورت میتوانید با مدیرت تالار تماس بگیرید و ضمنا پوشه اسپم ایمیل خود را نیز بررسی کنید',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'مدت زمان بازیابی پسورد شما منقضی شده است.',
	...
	'UCP_WELCOME'			=> 'به کنترل پنل کاربر خوش آمدید. در اینجا میتوانید بر پروفایل، ترجیحات و عضویت هایتان در موضوعات و انجمن های مختلف نظارت و بروزرسانی کنید. همچنین میتوانید به سایر کاربران پیام خصوصی بفرستید(اگر این بخش فعال باشد). لطفا قبل از هر اقدامی، اطلاعیه های موجود را بخوانید.',
