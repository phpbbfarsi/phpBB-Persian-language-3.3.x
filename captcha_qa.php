...
$lang = array_merge($lang, array(
	...
	'CONFIRM_QUESTION_EXPLAIN'		=> 'این پرسش یک وسیله برای جلوگیری از ارسال خودکار فرم توسط روبات های اسپم است.',
	...
	'QUESTIONS'				=> 'پرسش ها',
	'QUESTIONS_EXPLAIN'			=> 'اگر شما افزونه "پرسش و پاسخ" را فعال کرده باشید, برای ارسال هر فرم ،یکی از سوالات تعیین شده در اینجا از کاربران پرسیده خواهد شد. برای استفاده از این افزونه حداقل باید یک سوال در زبان پیش فرض تنظیم شده باشد. پاسخ گویی به این سوالات باید برای مخاطب هدف شما ساده اما فراتر از توانایی یک روبات که قادر است از گوگل جستجوی کند، باشد. استفاده از یک مجموعه بزرگ و که به طور منظم تغییر میکند، از سوالات به بهترین نتیجه منجر می شود. اگر سوالات شما متکی به ترکیب چند مورد است, "نقطه گذاری یا فضای خالی" تنظیمات سختگیرانه را فعال کنید.',
	...
	'QA_LAST_QUESTION'			=> 'شما نمی توانید هنگامی که افزونه فعال است تمامی پرسش ها را حذف کنید.',
